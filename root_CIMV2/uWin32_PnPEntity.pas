...
type
  ...
  public
   ...
   ///</summary>
   property CompatibleID : String read FCompatibleID;
   ///<summary>
   ...
   ///and Play device. See also: Win32_SystemDriverPNPEntity class.
   ///Example: atapi
   ///</summary>
...
{TWin32_PnPEntity}
 ...
 constructor TWin32_PnPEntity.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PnPEntity.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PnPEntity');
 end;
 ...
 begin
    ...
    begin
       ...
       FCompatibleID                        :=VarStrNull(GetPropertyValue('CompatibleID'));
       ...
       FService                             :=VarStrNull(GetPropertyValue('Service'));
...
function TWin32_PnPEntity.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_PnPEntity');
