...
{TWin32_PerfRawData_NETFramework_NETCLRLocksAndThreads}
 ...
 constructor TWin32_PerfRawData_NETFramework_NETCLRLocksAndThreads.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_NETFramework_NETCLRLocksAndThreads.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_NETFramework_NETCLRLocksAndThreads');
 end;
