...
type
  ...
  public
   ...
   ///<summary>
   ///The Description property indicates the full name of the codec driver. This 
   ///string is intended to be displayed in large (descriptive) spaces.
   ///Example: 
...
{TWin32_CodecFile}
 ...
 constructor TWin32_CodecFile.Create;
 begin
   Create(True);
 end;

 constructor TWin32_CodecFile.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_CodecFile');
 end;
 ...
 begin
    ...
    begin
       ...
       FGroup                               :=VarStrNull(GetPropertyValue('Group'));
...
begin
 Result:=-1;
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_CodecFile');
...
//not static, OutParams=1, InParams>0
function TWin32_CodecFile.ChangeSecurityPermissions(Option : LongInt;SecurityDescriptor : Variant): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_CodecFile.Copy(FileName : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_CodecFile.Rename(FileName : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_CodecFile.GetEffectivePermission(Permissions : LongInt): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
