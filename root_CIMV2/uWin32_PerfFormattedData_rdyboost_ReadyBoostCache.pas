...
{TWin32_PerfFormattedData_rdyboost_ReadyBoostCache}
 ...
 constructor TWin32_PerfFormattedData_rdyboost_ReadyBoostCache.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_rdyboost_ReadyBoostCache.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_rdyboost_ReadyBoostCache');
 end;
