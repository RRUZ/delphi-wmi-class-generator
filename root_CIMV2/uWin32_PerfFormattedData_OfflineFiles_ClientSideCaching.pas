...
{TWin32_PerfFormattedData_OfflineFiles_ClientSideCaching}
 ...
 constructor TWin32_PerfFormattedData_OfflineFiles_ClientSideCaching.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_OfflineFiles_ClientSideCaching.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_OfflineFiles_ClientSideCaching');
 end;
