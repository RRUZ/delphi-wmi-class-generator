...
{TWin32_PerfFormattedData_NETFramework_NETCLRJit}
 ...
 constructor TWin32_PerfFormattedData_NETFramework_NETCLRJit.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_NETFramework_NETCLRJit.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_NETFramework_NETCLRJit');
 end;
