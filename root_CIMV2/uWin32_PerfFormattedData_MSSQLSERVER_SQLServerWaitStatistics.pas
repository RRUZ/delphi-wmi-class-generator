...
{TWin32_PerfFormattedData_MSSQLSERVER_SQLServerWaitStatistics}
 ...
 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerWaitStatistics.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerWaitStatistics.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerWaitStatistics');
 end;
