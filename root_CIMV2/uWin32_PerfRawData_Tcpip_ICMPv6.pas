...
{TWin32_PerfRawData_Tcpip_ICMPv6}
 ...
 constructor TWin32_PerfRawData_Tcpip_ICMPv6.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Tcpip_ICMPv6.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Tcpip_ICMPv6');
 end;
