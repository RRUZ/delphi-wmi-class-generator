...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerReplicationLogreader}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerReplicationLogreader.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerReplicationLogreader.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerReplicationLogreader');
 end;
