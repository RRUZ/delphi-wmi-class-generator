...
{TWin32_PerfFormattedData_Counters_IPHTTPSGlobal}
 ...
 constructor TWin32_PerfFormattedData_Counters_IPHTTPSGlobal.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_Counters_IPHTTPSGlobal.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_Counters_IPHTTPSGlobal');
 end;
