...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerBufferManager}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerBufferManager.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerBufferManager.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerBufferManager');
 end;
 ...
 begin
    ...
    begin
       ...
       FBuffercachehitratio_Base            :=VarInt64Null(GetPropertyValue('Buffercachehitratio_Base'));
