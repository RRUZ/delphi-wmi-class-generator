...
/// Namespace root\CIMV2 Class Win32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSDatabases
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSDatabases.asp
/// </summary>
...
unit uWin32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSDatabases;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSDatabases=class(TWmiClass)
  private
...
{TWin32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSDatabases}

constructor TWin32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSDatabases.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSDatabases');
end;

destructor TWin32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSDatabases.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSDatabases.SetCollectionIndex(Index : Integer);
begin
