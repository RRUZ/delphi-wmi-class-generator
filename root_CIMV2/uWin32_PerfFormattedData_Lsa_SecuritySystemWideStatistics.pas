...
{TWin32_PerfFormattedData_Lsa_SecuritySystemWideStatistics}
 ...
 constructor TWin32_PerfFormattedData_Lsa_SecuritySystemWideStatistics.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_Lsa_SecuritySystemWideStatistics.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_Lsa_SecuritySystemWideStatistics');
 end;
