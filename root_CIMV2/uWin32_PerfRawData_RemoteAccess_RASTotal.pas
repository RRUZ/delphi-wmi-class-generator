...
{TWin32_PerfRawData_RemoteAccess_RASTotal}
 ...
 constructor TWin32_PerfRawData_RemoteAccess_RASTotal.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_RemoteAccess_RASTotal.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_RemoteAccess_RASTotal');
 end;
