...
{TWin32_PerfFormattedData_MSRS2008WebService_MSRS2008WebService}
 ...
 constructor TWin32_PerfFormattedData_MSRS2008WebService_MSRS2008WebService.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSRS2008WebService_MSRS2008WebService.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSRS2008WebService_MSRS2008WebService');
 end;
