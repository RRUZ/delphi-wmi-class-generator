...
{TWin32_PerfFormattedData_ReportServer_ReportServerService}
 ...
 constructor TWin32_PerfFormattedData_ReportServer_ReportServerService.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_ReportServer_ReportServerService.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_ReportServer_ReportServerService');
 end;
