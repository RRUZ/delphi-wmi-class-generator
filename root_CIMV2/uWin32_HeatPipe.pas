...
{TWin32_HeatPipe}
 ...
 constructor TWin32_HeatPipe.Create;
 begin
   Create(True);
 end;

 constructor TWin32_HeatPipe.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_HeatPipe');
 end;
...
function TWin32_HeatPipe.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_HeatPipe');
