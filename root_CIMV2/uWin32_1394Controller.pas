...
type
  ...
  public
   ...
   ///<summary>
   ///The Manufacturer property indicates the name of the manufacturer of the 1394 
   ///controller. 
   ///Example: Acme
   ///</summary>
...
{TWin32_1394Controller}
 ...
 constructor TWin32_1394Controller.Create;
 begin
   Create(True);
 end;

 constructor TWin32_1394Controller.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_1394Controller');
 end;
...
function TWin32_1394Controller.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_1394Controller');
