...
constructor TWin32_PerfFormattedData_Counters_Netlogon.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_Counters_Netlogon');
end;

destructor TWin32_PerfFormattedData_Counters_Netlogon.Destroy;
begin
  inherited;
end;
