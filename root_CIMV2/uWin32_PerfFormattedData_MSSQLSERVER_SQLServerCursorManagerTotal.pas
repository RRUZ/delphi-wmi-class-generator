...
{TWin32_PerfFormattedData_MSSQLSERVER_SQLServerCursorManagerTotal}
 ...
 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerCursorManagerTotal.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerCursorManagerTotal.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerCursorManagerTotal');
 end;
