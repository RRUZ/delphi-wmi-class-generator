...
{TWin32_PerfRawData_PerfOS_Objects}
 ...
 constructor TWin32_PerfRawData_PerfOS_Objects.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_PerfOS_Objects.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_PerfOS_Objects');
 end;
