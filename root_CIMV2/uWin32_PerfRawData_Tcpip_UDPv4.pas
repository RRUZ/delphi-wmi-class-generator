...
/// Creation Date 02-04-2011 16:31:54
/// Namespace root\CIMV2 Class Win32_PerfRawData_Tcpip_UDPv4
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_Tcpip_UDPv4.asp
/// </summary>
...
unit uWin32_PerfRawData_Tcpip_UDPv4;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_Tcpip_UDPv4=class(TWmiClass)
  private
    FCaption                            : String;
...
{TWin32_PerfRawData_Tcpip_UDPv4}

constructor TWin32_PerfRawData_Tcpip_UDPv4.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_Tcpip_UDPv4');
end;

destructor TWin32_PerfRawData_Tcpip_UDPv4.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_Tcpip_UDPv4.SetCollectionIndex(Index : Integer);
begin
