...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerTraceStatistics_Costly}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerTraceStatistics_Costly.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerTraceStatistics_Costly.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerTraceStatistics_Costly');
 end;
