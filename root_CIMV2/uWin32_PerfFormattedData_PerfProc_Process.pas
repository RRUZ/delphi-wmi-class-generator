...
/// Creation Date 22-12-2010 03:59:37
/// Namespace root\CIMV2 Class Win32_PerfFormattedData_PerfProc_Process
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfFormattedData_PerfProc_Process.asp
/// </summary>
...
unit uWin32_PerfFormattedData_PerfProc_Process;
...
{$ENDIF}
  ...
  TWin32_PerfFormattedData_PerfProc_Process=class(TWmiClass)
  private
    FCaption                            : String;
...
{TWin32_PerfFormattedData_PerfProc_Process}

constructor TWin32_PerfFormattedData_PerfProc_Process.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_PerfProc_Process');
end;

destructor TWin32_PerfFormattedData_PerfProc_Process.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfFormattedData_PerfProc_Process.SetCollectionIndex(Index : Integer);
begin
