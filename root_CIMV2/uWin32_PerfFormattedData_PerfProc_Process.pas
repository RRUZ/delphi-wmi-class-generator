...
{TWin32_PerfFormattedData_PerfProc_Process}
 ...
 constructor TWin32_PerfFormattedData_PerfProc_Process.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_PerfProc_Process.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_PerfProc_Process');
 end;
