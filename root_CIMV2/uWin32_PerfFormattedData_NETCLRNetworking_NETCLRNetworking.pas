...
{TWin32_PerfFormattedData_NETCLRNetworking_NETCLRNetworking}
 ...
 constructor TWin32_PerfFormattedData_NETCLRNetworking_NETCLRNetworking.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_NETCLRNetworking_NETCLRNetworking.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_NETCLRNetworking_NETCLRNetworking');
 end;
