...
{TWin32_CurrentProbe}
 ...
 constructor TWin32_CurrentProbe.Create;
 begin
   Create(True);
 end;

 constructor TWin32_CurrentProbe.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_CurrentProbe');
 end;
...
function TWin32_CurrentProbe.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_CurrentProbe');
