...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerBufferPartition}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerBufferPartition.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerBufferPartition.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerBufferPartition');
 end;
