...
/// Creation Date 24-12-2010 09:36:22
/// Namespace root\CIMV2 Class Win32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008ProcAggregations
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008ProcAggregations.asp
/// </summary>
...
unit uWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008ProcAggregations;
...
{$ENDIF}
  ...
  TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008ProcAggregations=class(TWmiClass)
  private
    FCaption                            : String;
...
{TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008ProcAggregations}

constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008ProcAggregations.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008ProcAggregations');
end;

destructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008ProcAggregations.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008ProcAggregations.SetCollectionIndex(Index : Integer);
begin
