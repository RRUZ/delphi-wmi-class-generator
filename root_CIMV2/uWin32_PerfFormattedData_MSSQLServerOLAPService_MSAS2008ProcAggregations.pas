...
{TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008ProcAggregations}
 ...
 constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008ProcAggregations.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008ProcAggregations.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008ProcAggregations');
 end;
