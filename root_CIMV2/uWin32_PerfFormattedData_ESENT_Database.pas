...
{TWin32_PerfFormattedData_ESENT_Database}
 ...
 constructor TWin32_PerfFormattedData_ESENT_Database.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_ESENT_Database.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_ESENT_Database');
 end;
