...
{TWin32_PerfRawData_RemoteAccess_RASPort}
 ...
 constructor TWin32_PerfRawData_RemoteAccess_RASPort.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_RemoteAccess_RASPort.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_RemoteAccess_RASPort');
 end;
