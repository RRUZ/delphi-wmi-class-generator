...
{TWin32_PerfFormattedData_MSSQLSERVER_SQLServerDatabases}
 ...
 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerDatabases.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerDatabases.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerDatabases');
 end;
