...
{TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008MDX}
 ...
 constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008MDX.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008MDX.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008MDX');
 end;
