...
{TWin32_PerfRawData_LocalSessionManager_TerminalServices}
 ...
 constructor TWin32_PerfRawData_LocalSessionManager_TerminalServices.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_LocalSessionManager_TerminalServices.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_LocalSessionManager_TerminalServices');
 end;
