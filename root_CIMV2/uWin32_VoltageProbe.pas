...
{TWin32_VoltageProbe}
 ...
 constructor TWin32_VoltageProbe.Create;
 begin
   Create(True);
 end;

 constructor TWin32_VoltageProbe.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_VoltageProbe');
 end;
...
function TWin32_VoltageProbe.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_VoltageProbe');
