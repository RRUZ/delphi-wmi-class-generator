...
type
   ///<summary>
   ///The Win32_ParallelPort class represents the properties of a parallel port on a 
  ...
  public
   ...
   ///the parallel controller features indicated in the Capabilities array. Note, 
   ///each entry of this array is related to the entry in the Capabilities array that 
   ...
   ///<summary>
   ///The DeviceID property contains a string identifying the parallel port.
   ///</summary>
   ...
   ///<summary>
   ///The OSAutoDiscovered property indicates whether the parallel port was 
   ///automatically detected by the operating system or by other means (such as being 
   ///manually added through the Control Panel).
   ///Values: TRUE or FALSE. A value of 
   ///TRUE indicates the parallel port was automatically discovered by the operating 
   ///system.
   ///</summary>
...
{TWin32_ParallelPort}
 ...
 constructor TWin32_ParallelPort.Create;
 begin
   Create(True);
 end;

 constructor TWin32_ParallelPort.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_ParallelPort');
 end;
 ...
 begin
    ...
    begin
       ...
       FDMASupport                          :=VarBoolNull(GetPropertyValue('DMASupport'));
...
function TWin32_ParallelPort.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_ParallelPort');
