...
{TWin32_PerfRawData_VMware_VMware}
 ...
 constructor TWin32_PerfRawData_VMware_VMware.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_VMware_VMware.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_VMware_VMware');
 end;
