...
type
  ...
  public
   ...
   ///<summary>
   ///An integer indicating whether a hardware-level password is enabled at the 
   ///keyboard (value=4), preventing local input. Other values are:  "Disabled" (3), 
   ///"Not Implemented" (5), "Other" (1) and "Unknown" (2).
   ///</summary>
...
{TWin32_Keyboard}
 ...
 constructor TWin32_Keyboard.Create;
 begin
   Create(True);
 end;

 constructor TWin32_Keyboard.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_Keyboard');
 end;
 ...
 begin
    ...
    begin
       ...
       FLayout                              :=VarStrNull(GetPropertyValue('Layout'));
       FName                                :=VarStrNull(GetPropertyValue('Name'));
       FNumberOfFunctionKeys                :=VarWordNull(GetPropertyValue('NumberOfFunctionKeys'));
       FPassword                            :=VarWordNull(GetPropertyValue('Password'));
...
function TWin32_Keyboard.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_Keyboard');
