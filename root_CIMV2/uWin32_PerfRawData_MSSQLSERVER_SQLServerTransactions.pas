...
/// Creation Date 23-02-2011 23:38:47
/// Namespace root\CIMV2 Class Win32_PerfRawData_MSSQLSERVER_SQLServerTransactions
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_MSSQLSERVER_SQLServerTransactions.asp
/// </summary>
...
unit uWin32_PerfRawData_MSSQLSERVER_SQLServerTransactions;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_MSSQLSERVER_SQLServerTransactions=class(TWmiClass)
  private
    FCaption                            : String;
    FDescription                        : String;
...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerTransactions}

constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerTransactions.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerTransactions');
end;

destructor TWin32_PerfRawData_MSSQLSERVER_SQLServerTransactions.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_MSSQLSERVER_SQLServerTransactions.SetCollectionIndex(Index : Integer);
begin
