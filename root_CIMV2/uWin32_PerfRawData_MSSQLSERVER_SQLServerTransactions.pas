...
type
  ...
  private
   ...
   FUpdateconflictratio_Base           : LongInt;
  ...
  public
   ...
   property Updateconflictratio_Base : LongInt read FUpdateconflictratio_Base;
   ///<summary>
...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerTransactions}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerTransactions.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerTransactions.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerTransactions');
 end;
 ...
 begin
    ...
    begin
       ...
       FUpdateconflictratio_Base            :=VarLongNull(GetPropertyValue('Updateconflictratio_Base'));
