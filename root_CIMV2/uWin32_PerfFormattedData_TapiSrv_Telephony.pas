...
{TWin32_PerfFormattedData_TapiSrv_Telephony}
 ...
 constructor TWin32_PerfFormattedData_TapiSrv_Telephony.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_TapiSrv_Telephony.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_TapiSrv_Telephony');
 end;
