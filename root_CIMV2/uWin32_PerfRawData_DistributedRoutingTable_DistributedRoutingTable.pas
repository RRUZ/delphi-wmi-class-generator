...
{TWin32_PerfRawData_DistributedRoutingTable_DistributedRoutingTable}
 ...
 constructor TWin32_PerfRawData_DistributedRoutingTable_DistributedRoutingTable.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_DistributedRoutingTable_DistributedRoutingTable.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_DistributedRoutingTable_DistributedRoutingTable');
 end;
