...
{TWin32_PerfFormattedData_MSSQLSERVER_SQLServerSQLStatistics}
 ...
 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerSQLStatistics.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerSQLStatistics.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerSQLStatistics');
 end;
