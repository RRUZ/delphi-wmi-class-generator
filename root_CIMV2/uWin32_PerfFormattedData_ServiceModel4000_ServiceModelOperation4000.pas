...
{TWin32_PerfFormattedData_ServiceModel4000_ServiceModelOperation4000}
 ...
 constructor TWin32_PerfFormattedData_ServiceModel4000_ServiceModelOperation4000.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_ServiceModel4000_ServiceModelOperation4000.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_ServiceModel4000_ServiceModelOperation4000');
 end;
