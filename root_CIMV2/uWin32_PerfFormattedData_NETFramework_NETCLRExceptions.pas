...
{TWin32_PerfFormattedData_NETFramework_NETCLRExceptions}
 ...
 constructor TWin32_PerfFormattedData_NETFramework_NETCLRExceptions.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_NETFramework_NETCLRExceptions.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_NETFramework_NETCLRExceptions');
 end;
