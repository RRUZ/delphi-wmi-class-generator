...
{TWin32_PerfRawData_Tcpip_NBTConnection}
 ...
 constructor TWin32_PerfRawData_Tcpip_NBTConnection.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Tcpip_NBTConnection.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Tcpip_NBTConnection');
 end;
