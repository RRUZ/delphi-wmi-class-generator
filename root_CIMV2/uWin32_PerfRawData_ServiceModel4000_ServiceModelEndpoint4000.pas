...
/// Creation Date 24-12-2010 09:37:42
/// Namespace root\CIMV2 Class Win32_PerfRawData_ServiceModel4000_ServiceModelEndpoint4000
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_ServiceModel4000_ServiceModelEndpoint4000.asp
/// </summary>
...
unit uWin32_PerfRawData_ServiceModel4000_ServiceModelEndpoint4000;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_ServiceModel4000_ServiceModelEndpoint4000=class(TWmiClass)
  private
    FCalls                              : Cardinal;
...
{TWin32_PerfRawData_ServiceModel4000_ServiceModelEndpoint4000}

constructor TWin32_PerfRawData_ServiceModel4000_ServiceModelEndpoint4000.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_ServiceModel4000_ServiceModelEndpoint4000');
end;

destructor TWin32_PerfRawData_ServiceModel4000_ServiceModelEndpoint4000.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_ServiceModel4000_ServiceModelEndpoint4000.SetCollectionIndex(Index : Integer);
begin
