...
{TWin32_PerfRawData_MSDTC_DistributedTransactionCoordinator}
 ...
 constructor TWin32_PerfRawData_MSDTC_DistributedTransactionCoordinator.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSDTC_DistributedTransactionCoordinator.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSDTC_DistributedTransactionCoordinator');
 end;
