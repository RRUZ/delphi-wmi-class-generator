...
constructor TWin32_PerfRawData_AuthorizationManager_AuthorizationManagerApplications.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_AuthorizationManager_AuthorizationManagerApplications');
end;

destructor TWin32_PerfRawData_AuthorizationManager_AuthorizationManagerApplications.Destroy;
begin
  inherited;
end;
