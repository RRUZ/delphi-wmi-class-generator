...
{TWin32_PerfFormattedData_MSRS2008WindowsService_MSRS2008WindowsService}
 ...
 constructor TWin32_PerfFormattedData_MSRS2008WindowsService_MSRS2008WindowsService.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSRS2008WindowsService_MSRS2008WindowsService.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSRS2008WindowsService_MSRS2008WindowsService');
 end;
