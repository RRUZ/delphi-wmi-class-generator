...
/// Creation Date 22-12-2010 03:57:52
...
{$ENDIF}
  ...
  public
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The PrimaryBusType property indicates the primary bus type of the motherboard.
   /// Example: PCI
   /// </summary>
   {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The RevisionNumber property indicates the revision number of the motherboard.
   /// Example: 00
   /// </summary>
   {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The SecondaryBusType property indicates the secondary bus type of the motherboard.
   /// Example: ISA
   /// </summary>
   {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// TWin32_MotherboardDevice.Availability
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_MotherboardDevice.ConfigManagerErrorCode
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_MotherboardDevice.PowerManagementCapabilities
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_MotherboardDevice.StatusInfo
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
