...
{TWin32_SystemLoadOrderGroups}
 ...
 constructor TWin32_SystemLoadOrderGroups.Create;
 begin
   Create(True);
 end;

 constructor TWin32_SystemLoadOrderGroups.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_SystemLoadOrderGroups');
 end;
