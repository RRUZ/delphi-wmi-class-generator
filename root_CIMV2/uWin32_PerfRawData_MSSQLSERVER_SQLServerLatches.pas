...
constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerLatches.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerLatches');
end;

destructor TWin32_PerfRawData_MSSQLSERVER_SQLServerLatches.Destroy;
begin
  inherited;
end;
