...
{TWin32_PerfFormattedData_Tcpip_TCPv6}
 ...
 constructor TWin32_PerfFormattedData_Tcpip_TCPv6.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_Tcpip_TCPv6.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_Tcpip_TCPv6');
 end;
