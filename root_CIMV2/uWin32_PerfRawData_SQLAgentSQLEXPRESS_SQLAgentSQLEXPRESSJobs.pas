...
/// Namespace root\CIMV2 Class Win32_PerfRawData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSJobs
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSJobs.asp
/// </summary>
...
unit uWin32_PerfRawData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSJobs;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSJobs=class(TWmiClass)
  private
    FActivejobs                         : Int64;
    FCaption                            : String;
    FDescription                        : String;
...
{TWin32_PerfRawData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSJobs}

constructor TWin32_PerfRawData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSJobs.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSJobs');
end;

destructor TWin32_PerfRawData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSJobs.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSJobs.SetCollectionIndex(Index : Integer);
begin
