...
type
  ...
  private
   ...
   FLogCheckpointDepthasaPercentofTarget_Base : LongInt;
  ...
  public
   ...
   property LogCheckpointDepthasaPercentofTarget_Base : LongInt read FLogCheckpointDepthasaPercentofTarget_Base;
   ///<summary>
...
{TWin32_PerfRawData_ESENT_DatabaseInstances}
 ...
 constructor TWin32_PerfRawData_ESENT_DatabaseInstances.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_ESENT_DatabaseInstances.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_ESENT_DatabaseInstances');
 end;
 ...
 begin
    ...
    begin
       ...
       FLogCheckpointDepthasaPercentofTarget_Base  :=VarLongNull(GetPropertyValue('LogCheckpointDepthasaPercentofTarget_Base'));
