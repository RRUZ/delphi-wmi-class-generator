...
{TWin32_PerfRawData_WSearchIdxPi_SearchIndexer}
 ...
 constructor TWin32_PerfRawData_WSearchIdxPi_SearchIndexer.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_WSearchIdxPi_SearchIndexer.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_WSearchIdxPi_SearchIndexer');
 end;
