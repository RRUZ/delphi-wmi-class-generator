...
{TWin32_PerfFormattedData_Tcpip_ICMP}
 ...
 constructor TWin32_PerfFormattedData_Tcpip_ICMP.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_Tcpip_ICMP.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_Tcpip_ICMP');
 end;
