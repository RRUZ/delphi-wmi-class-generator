...
{TWin32_PerfFormattedData_Counters_TeredoClient}
 ...
 constructor TWin32_PerfFormattedData_Counters_TeredoClient.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_Counters_TeredoClient.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_Counters_TeredoClient');
 end;
