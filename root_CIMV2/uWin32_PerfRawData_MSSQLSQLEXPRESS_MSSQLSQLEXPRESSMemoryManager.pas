...
/// Namespace root\CIMV2 Class Win32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSMemoryManager
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSMemoryManager.asp
/// </summary>
...
unit uWin32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSMemoryManager;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSMemoryManager=class(TWmiClass)
  private
    FCaption                            : String;
...
{TWin32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSMemoryManager}

constructor TWin32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSMemoryManager.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSMemoryManager');
end;

destructor TWin32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSMemoryManager.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSMemoryManager.SetCollectionIndex(Index : Integer);
begin
