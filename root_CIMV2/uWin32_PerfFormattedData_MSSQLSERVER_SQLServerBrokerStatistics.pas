...
{TWin32_PerfFormattedData_MSSQLSERVER_SQLServerBrokerStatistics}
 ...
 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerBrokerStatistics.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerBrokerStatistics.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerBrokerStatistics');
 end;
