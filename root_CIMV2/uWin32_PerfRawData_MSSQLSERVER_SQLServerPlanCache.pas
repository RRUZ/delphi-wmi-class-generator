...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerPlanCache}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerPlanCache.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerPlanCache.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerPlanCache');
 end;
