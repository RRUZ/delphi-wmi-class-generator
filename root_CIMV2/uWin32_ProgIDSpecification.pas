...
{TWin32_ProgIDSpecification}
 ...
 constructor TWin32_ProgIDSpecification.Create;
 begin
   Create(True);
 end;

 constructor TWin32_ProgIDSpecification.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_ProgIDSpecification');
 end;
 ...
 begin
    ...
    begin
       ...
       FParent                              :=VarStrNull(GetPropertyValue('Parent'));
...
begin
 Result:=-1;
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_ProgIDSpecification');
