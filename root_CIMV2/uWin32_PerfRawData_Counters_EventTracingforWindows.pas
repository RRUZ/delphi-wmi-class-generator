...
/// Creation Date 13-10-2012 10:54:57
/// Namespace root\CIMV2 Class Win32_PerfRawData_Counters_EventTracingforWindows
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_Counters_EventTracingforWindows.asp
/// </summary>
...
unit uWin32_PerfRawData_Counters_EventTracingforWindows;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_Counters_EventTracingforWindows=class(TWmiClass)
  private
    FCaption                            : String;
    FDescription                        : String;
...
{TWin32_PerfRawData_Counters_EventTracingforWindows}

constructor TWin32_PerfRawData_Counters_EventTracingforWindows.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_Counters_EventTracingforWindows');
end;

destructor TWin32_PerfRawData_Counters_EventTracingforWindows.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_Counters_EventTracingforWindows.SetCollectionIndex(Index : Integer);
begin
