...
{TWin32_PerfFormattedData_MSSQLSERVER_SQLServerReplicationDist}
 ...
 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerReplicationDist.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerReplicationDist.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerReplicationDist');
 end;
