...
{TWin32_PerfFormattedData_NETDataProviderforSqlServer_NETDataProviderforSqlServer}
 ...
 constructor TWin32_PerfFormattedData_NETDataProviderforSqlServer_NETDataProviderforSqlServer.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_NETDataProviderforSqlServer_NETDataProviderforSqlServer.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_NETDataProviderforSqlServer_NETDataProviderforSqlServer');
 end;
