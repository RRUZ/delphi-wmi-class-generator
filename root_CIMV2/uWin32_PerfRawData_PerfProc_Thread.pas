...
{TWin32_PerfRawData_PerfProc_Thread}
 ...
 constructor TWin32_PerfRawData_PerfProc_Thread.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_PerfProc_Thread.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_PerfProc_Thread');
 end;
