...
/// Namespace root\CIMV2 Class Win32_PerfRawData_PerfProc_Thread
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_PerfProc_Thread.asp
/// </summary>
...
unit uWin32_PerfRawData_PerfProc_Thread;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_PerfProc_Thread=class(TWmiClass)
  private
    FCaption                            : String;
...
{TWin32_PerfRawData_PerfProc_Thread}

constructor TWin32_PerfRawData_PerfProc_Thread.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_PerfProc_Thread');
end;

destructor TWin32_PerfRawData_PerfProc_Thread.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_PerfProc_Thread.SetCollectionIndex(Index : Integer);
begin
