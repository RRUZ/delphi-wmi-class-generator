...
/// Namespace root\CIMV2 Class Win32_PerfRawData_NETCLRData_NETCLRData
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_NETCLRData_NETCLRData.asp
/// </summary>
...
unit uWin32_PerfRawData_NETCLRData_NETCLRData;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_NETCLRData_NETCLRData=class(TWmiClass)
  private
    FCaption                            : String;
    FDescription                        : String;
...
{TWin32_PerfRawData_NETCLRData_NETCLRData}

constructor TWin32_PerfRawData_NETCLRData_NETCLRData.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_NETCLRData_NETCLRData');
end;

destructor TWin32_PerfRawData_NETCLRData_NETCLRData.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_NETCLRData_NETCLRData.SetCollectionIndex(Index : Integer);
begin
