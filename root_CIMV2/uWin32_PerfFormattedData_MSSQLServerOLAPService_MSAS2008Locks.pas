...
{TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Locks}
 ...
 constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Locks.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Locks.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Locks');
 end;
