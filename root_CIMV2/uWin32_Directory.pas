...
type
   ///<summary>
   ///The Win32_Directory class represents a directory entry on a Win32 computer 
   ///system. Directory is a type of file that logically groups data files 
   ///'contained' in it and provides path information for the grouped files.
   ///Example: 
   ///C:\TEMP.
   ///</summary>
...
{TWin32_Directory}
 ...
 constructor TWin32_Directory.Create;
 begin
   Create(True);
 end;

 constructor TWin32_Directory.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_Directory');
 end;
...
begin
 Result:=-1;
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_Directory');
...
//not static, OutParams=1, InParams>0
function TWin32_Directory.ChangeSecurityPermissions(Option : LongInt;SecurityDescriptor : Variant): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_Directory.Copy(FileName : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_Directory.Rename(FileName : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_Directory.GetEffectivePermission(Permissions : LongInt): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
