...
{TWin32_PerfRawData_Tcpip_NetworkInterface}
 ...
 constructor TWin32_PerfRawData_Tcpip_NetworkInterface.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Tcpip_NetworkInterface.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Tcpip_NetworkInterface');
 end;
