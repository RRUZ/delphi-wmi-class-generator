...
{TWin32_PerfRawData_Counters_TeredoRelay}
 ...
 constructor TWin32_PerfRawData_Counters_TeredoRelay.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Counters_TeredoRelay.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Counters_TeredoRelay');
 end;
