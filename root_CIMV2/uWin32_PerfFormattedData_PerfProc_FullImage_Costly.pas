...
{TWin32_PerfFormattedData_PerfProc_FullImage_Costly}
 ...
 constructor TWin32_PerfFormattedData_PerfProc_FullImage_Costly.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_PerfProc_FullImage_Costly.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_PerfProc_FullImage_Costly');
 end;
