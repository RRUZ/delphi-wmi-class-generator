...
type
  ...
  private
   ...
   FAverageWaitTimems_Base             : LongInt;
   FCaption                            : String;
   FDescription                        : String;
  ...
  public
   ...
   property AverageWaitTimems_Base : LongInt read FAverageWaitTimems_Base;
   ///<summary>
...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerLocks}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerLocks.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerLocks.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerLocks');
 end;
 ...
 begin
    ...
    begin
       ...
       FAverageWaitTimems_Base              :=VarLongNull(GetPropertyValue('AverageWaitTimems_Base'));
