...
/// Creation Date 23-02-2011 23:37:24
/// Namespace root\CIMV2 Class Win32_Bus
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_Bus.asp
/// </summary>
...
{$ENDIF}
  ...
  /// <summary>
  /// The Win32_Bus class represents a physical bus as seen by a Win32 operating system. Any instance of a Win32 bus is a descendent (or member) of this class.
  /// Example: USB Bus.
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  TWin32_Bus=class(TWmiClass)
  private
    FAvailability                       : Word;
    FBusNum                             : Cardinal;
    FBusType                            : Cardinal;
  ...
  public
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The BusNum property indicates the logical number assigned to the physical bus.
   /// Example: 1
   /// </summary>
   {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
   property BusNum : Cardinal read FBusNum;
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The BusType property indicates the type of the physical bus. This value will be one of the values in the INTERFACE_TYPE enumeration defined in bus.h.
   /// Example: PCIBus
   /// </summary>
   {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
   property BusType : Cardinal read FBusType;
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The DeviceID property contains a unique name that identifies the bus.
   /// </summary>
   {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
  /// <summary>
  /// Return the description for the value of the property TWin32_Bus.Availability
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  function GetAvailabilityAsString(const APropValue:Word) : string;
  {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
  /// <summary>
  /// Return the description for the value of the property TWin32_Bus.BusType
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  function GetBusTypeAsString(const APropValue:Cardinal) : string;
  {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_Bus.ConfigManagerErrorCode
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_Bus.PowerManagementCapabilities
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  function GetPowerManagementCapabilitiesAsString(const APropValue:Word) : string;
  {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
  /// <summary>
  /// Return the description for the value of the property TWin32_Bus.StatusInfo
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
...
Result:='';
  case APropValue of
    ...
    1 : Result:='ISA';
    2 : Result:='EISA';
    3 : Result:='MicroChannel';
    4 : Result:='TurboChannel';
    5 : Result:='PCI Bus';
    6 : Result:='VME Bus';
    7 : Result:='NuBus';
    8 : Result:='PCMCIA Bus';
    ...
    10 : Result:='MPI Bus';
    11 : Result:='MPSA Bus';
    12 : Result:='Internal Processor';
    13 : Result:='Internal Power Bus';
    14 : Result:='PNP ISA Bus';
    15 : Result:='PNP Bus';
    16 : Result:='Maximum Interface Type';
  end;
end;
...
constructor TWin32_Bus.Create(LoadWmiData : boolean=True);
begin
  SetLength(FPowerManagementCapabilities,0);
  inherited Create(LoadWmiData,'root\CIMV2','Win32_Bus');
end;

destructor TWin32_Bus.Destroy;
begin
  SetLength(FPowerManagementCapabilities,0);
  inherited;
end;

procedure TWin32_Bus.SetCollectionIndex(Index : Integer);
begin
  if (Index>=0) and (Index<=FWmiCollection.Count-1) and (FWmiCollectionIndex<>Index) then
  begin
    FWmiCollectionIndex:=Index;
    FAvailability                     := VarWordNull(inherited Value['Availability']);
    FBusNum                           := VarCardinalNull(inherited Value['BusNum']);
    FBusType                          := VarCardinalNull(inherited Value['BusType']);
...
function TWin32_Bus.SetPowerState(const PowerState : Word;const Time : TDateTime): Integer;
var
...
//not static, OutParams=1, InParams=0
function TWin32_Bus.Reset: integer;
var
  ReturnValue : OleVariant;
begin
