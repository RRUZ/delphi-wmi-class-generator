...
{TWin32_PerfRawData_MSDTCBridge3000_MSDTCBridge3000}
 ...
 constructor TWin32_PerfRawData_MSDTCBridge3000_MSDTCBridge3000.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSDTCBridge3000_MSDTCBridge3000.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSDTCBridge3000_MSDTCBridge3000');
 end;
