...
/// Creation Date 24-12-2010 09:38:14
/// Namespace root\CIMV2 Class Win32_SoundDevice
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_SoundDevice.asp
/// </summary>
...
{$ENDIF}
  ...
  /// <summary>
  /// The Win32_SoundDevice class represents the properties of a sound device on a 
  /// Win32 computer system.
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  TWin32_SoundDevice=class(TWmiClass)
  private
    FAvailability                       : Word;
    FCaption                            : String;
  ...
  public
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The DeviceID property contains information that uniquely identifies the sound 
   /// device.
   /// </summary>
   {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The DMABufferSize property indicates the size of the Direct Memory Access buffer.
   /// Example: 4
   /// </summary>
   {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
   property DMABufferSize : Word read FDMABufferSize;
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The Manufacturer property names the manufacturer of the sound device.
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The MPU401Address property indicates the starting I/O address assigned to the MPU-401 port of the sound device.
   /// Example: 300
   /// </summary>
   {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
   property MPU401Address : Cardinal read FMPU401Address;
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The ProductName property indicates the product name of the sound device.
  ...
  /// TWin32_SoundDevice.Availability
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_SoundDevice.ConfigManagerErrorCode
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_SoundDevice.PowerManagementCapabilities
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
...
constructor TWin32_SoundDevice.Create(LoadWmiData : boolean=True);
begin
  SetLength(FPowerManagementCapabilities,0);
  inherited Create(LoadWmiData,'root\CIMV2','Win32_SoundDevice');
end;

destructor TWin32_SoundDevice.Destroy;
begin
  SetLength(FPowerManagementCapabilities,0);
  inherited;
end;

procedure TWin32_SoundDevice.SetCollectionIndex(Index : Integer);
begin
  ...
  begin
    ...
    FDMABufferSize                    := VarWordNull(inherited Value['DMABufferSize']);
    ...
    FMPU401Address                    := VarCardinalNull(inherited Value['MPU401Address']);
...
function TWin32_SoundDevice.SetPowerState(const PowerState : Word;const Time : TDateTime): Integer;
var
...
//not static, OutParams=1, InParams=0
function TWin32_SoundDevice.Reset: integer;
var
  ReturnValue : OleVariant;
begin
