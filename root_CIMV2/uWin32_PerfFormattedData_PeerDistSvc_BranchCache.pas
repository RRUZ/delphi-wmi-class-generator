...
{TWin32_PerfFormattedData_PeerDistSvc_BranchCache}
 ...
 constructor TWin32_PerfFormattedData_PeerDistSvc_BranchCache.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_PeerDistSvc_BranchCache.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_PeerDistSvc_BranchCache');
 end;
