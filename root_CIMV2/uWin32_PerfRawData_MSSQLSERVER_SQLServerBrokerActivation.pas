...
/// Creation Date 24-12-2010 09:37:07
/// Namespace root\CIMV2 Class Win32_PerfRawData_MSSQLSERVER_SQLServerBrokerActivation
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_MSSQLSERVER_SQLServerBrokerActivation.asp
/// </summary>
...
unit uWin32_PerfRawData_MSSQLSERVER_SQLServerBrokerActivation;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_MSSQLSERVER_SQLServerBrokerActivation=class(TWmiClass)
  private
    FCaption                            : String;
    FDescription                        : String;
...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerBrokerActivation}

constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerBrokerActivation.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerBrokerActivation');
end;

destructor TWin32_PerfRawData_MSSQLSERVER_SQLServerBrokerActivation.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_MSSQLSERVER_SQLServerBrokerActivation.SetCollectionIndex(Index : Integer);
begin
