...
{TWin32_PerfFormattedData_PerfDisk_LogicalDisk}
 ...
 constructor TWin32_PerfFormattedData_PerfDisk_LogicalDisk.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_PerfDisk_LogicalDisk.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_PerfDisk_LogicalDisk');
 end;
