...
/// Namespace root\CIMV2 Class WiFi_AvailableNetwork
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/WiFi_AvailableNetwork.asp
/// </summary>
...
{$ENDIF}
  ...
  TWiFi_AvailableNetwork=class(TWmiClass)
  private
    FAuthLevel                          : String;
    FBand                               : String;
    FCaption                            : String;
...
{TWiFi_AvailableNetwork}

constructor TWiFi_AvailableNetwork.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','WiFi_AvailableNetwork');
end;

destructor TWiFi_AvailableNetwork.Destroy;
begin
  inherited;
end;

procedure TWiFi_AvailableNetwork.SetCollectionIndex(Index : Integer);
begin
