...
constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerWaitStatistics.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerWaitStatistics');
end;

destructor TWin32_PerfRawData_MSSQLSERVER_SQLServerWaitStatistics.Destroy;
begin
  inherited;
end;
