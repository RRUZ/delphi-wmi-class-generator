...
/// Creation Date 24-12-2010 09:37:18
/// Namespace root\CIMV2 Class Win32_PerfRawData_MSSQLServerOLAPService_MSAS2008Connection
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_MSSQLServerOLAPService_MSAS2008Connection.asp
/// </summary>
...
unit uWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008Connection;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008Connection=class(TWmiClass)
  private
    FCaption                            : String;
...
{TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008Connection}

constructor TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008Connection.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_MSSQLServerOLAPService_MSAS2008Connection');
end;

destructor TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008Connection.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008Connection.SetCollectionIndex(Index : Integer);
begin
