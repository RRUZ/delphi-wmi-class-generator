...
{TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008Connection}
 ...
 constructor TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008Connection.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008Connection.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLServerOLAPService_MSAS2008Connection');
 end;
