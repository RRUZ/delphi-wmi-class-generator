...
{TWin32_PerfFormattedData_Counters_IPsecIKEv2IPv4}
 ...
 constructor TWin32_PerfFormattedData_Counters_IPsecIKEv2IPv4.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_Counters_IPsecIKEv2IPv4.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_Counters_IPsecIKEv2IPv4');
 end;
