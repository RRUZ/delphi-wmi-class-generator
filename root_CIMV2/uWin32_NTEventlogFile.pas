...
type
   ...
   ///changed in future releases. Currently the provider returns both files on fixed 
   ///disks as well as files on mapped logical disks. In the future, only instances 
   ///of files on local fixed disks will be returned.<B>
   ///</summary>
  ...
  private
   ...
   FName                               : String;
   FNumberOfRecords                    : LongInt;
   FOverwriteOutDated                  : LongInt;
  ...
  public
   ...
   ///limit. 
   ///</summary>
   property MaxFileSize : LongInt read FMaxFileSize;
   ///<summary>
   ...
   ///</summary>
   property NumberOfRecords : LongInt read FNumberOfRecords;
   ///<summary>
   ///Number of days after which an event can be overwritten. Values are:
   ///0 = Any 
   ///entry can be overwritten when necessary.1..365 = Events that have been in the 
   ///log file for one year (365 days) or less can be overwritten.4294967295 = 
   ///Nothing can be ever be overwritten. 
   ///There is an interdependence between the 
   ///OverWriteOutDated property (which is writable) value and the OverWritePolicy 
   ///property (which is not writable) value.
   ///If one changes the OverWriteOutDated 
   ///property value to 0, the OverWritePolicy property value will be 'henNeeded' 
   ///If 
   ///one changes the OverWriteOutDated property value to 1-365, the OverWritePolicy 
   ///property value will be 'outDated' 
   ///If one changes the OverWriteOutDated 
   ///property value to 4294967295, the OverWritePolicy property value will be 
   ///'Never'.
   ///</summary>
   property OverwriteOutDated : LongInt read FOverwriteOutDated;
   ///<summary>
   ///Current overwrite policy the Windows NT/Windows 2000 Event Log service employs 
   ///for this log file. The possible values of the property are: 
   ///WhenNeeded - This 
   ///corresponds to OverWriteOutdated = 0.
   ///OutDated - This corresponds to 
   ///OverWriteOutdated of 1 to 365.
   ///Never - This corresponds to OverWriteOutdated = 
   ///4294967295. 
   ///There is an interdependence between the OverWriteOutDated property 
   ///(which is writable) value and the OverWritePolicy property (which is not 
   ///writable) value.
   ///If one changes the OverWriteOutDated property value to 0, the 
   ///OverWritePolicy property value will be 'henNeeded' 
   ///If one changes the 
   ///OverWriteOutDated property value to 1-365, the OverWritePolicy property value 
   ///will be 'outDated' 
   ///If one changes the OverWriteOutDated property value to 
   ///4294967295, the OverWritePolicy property value will be 'Never'.
   ///</summary>
...
//  Unsupported WmiMethod UncompressEx
   ...
   ///<summary>
   ///Clears the specified event log, and optionally saves the current copy of the 
   ///logfile to a backup file. The method returns an integer value that can be 
   ///interpretted as follows: 
   ///0 - Successful completion.
   ///8 - The user does not have 
   ///adequate privileges.
   ///21 - Invalid parameter.
   ///Other - For integer values other 
   ///than those listed above, refer to Win32 error code documentation.
   ///</summary>
   function ClearEventlog(ArchiveFileName : String): Integer;
   ///<summary>
   ///Saves the specified event log to a backup file. The method returns an integer 
   ///value that can be interpretted as follows: 
   ///0 - Successful completion.
   ///8 - The 
   ///user does not have adequate privileges.
   ///21 - Invalid parameter.
   ///183 - Archive 
   ///file name already exists. Cannot create file. 
   ///Other - For integer values other 
   ///than those listed above, refer to Win32 error code documentation.
   ///</summary>
   function BackupEventlog(ArchiveFileName : String): Integer;
...
{TWin32_NTEventlogFile}
 ...
 constructor TWin32_NTEventlogFile.Create;
 begin
   Create(True);
 end;

 constructor TWin32_NTEventlogFile.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_NTEventlogFile');
 end;
 ...
 begin
    ...
    begin
       ...
       FLogfileName                         :=VarStrNull(GetPropertyValue('LogfileName'));
       FManufacturer                        :=VarStrNull(GetPropertyValue('Manufacturer'));
       FMaxFileSize                         :=VarLongNull(GetPropertyValue('MaxFileSize'));
       FName                                :=VarStrNull(GetPropertyValue('Name'));
       FNumberOfRecords                     :=VarLongNull(GetPropertyValue('NumberOfRecords'));
       FOverwriteOutDated                   :=VarLongNull(GetPropertyValue('OverwriteOutDated'));
       FOverWritePolicy                     :=VarStrNull(GetPropertyValue('OverWritePolicy'));
       FPath                                :=VarStrNull(GetPropertyValue('Path'));
       FReadable                            :=VarBoolNull(GetPropertyValue('Readable'));
       FSources                             :=VarStrNull(GetPropertyValue('Sources'));
...
begin
 Result:=-1;
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_NTEventlogFile');
...
//not static, OutParams=1, InParams>0
function TWin32_NTEventlogFile.ChangeSecurityPermissions(Option : LongInt;SecurityDescriptor : Variant): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_NTEventlogFile.Copy(FileName : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_NTEventlogFile.Rename(FileName : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_NTEventlogFile.GetEffectivePermission(Permissions : LongInt): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_NTEventlogFile.ClearEventlog(ArchiveFileName : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
begin
  ...
  if CurrIndex=FWmiCollectionIndex then
    begin
     ReturnValue:=colItem.ClearEventlog(ArchiveFileName);
     Result     :=VarIntegerNull(ReturnValue);
     Exit;
    end;
   Inc(CurrIndex);
...
//not static, OutParams=1, InParams>0
function TWin32_NTEventlogFile.BackupEventlog(ArchiveFileName : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
begin
  ...
  if CurrIndex=FWmiCollectionIndex then
    begin
     ReturnValue:=colItem.BackupEventlog(ArchiveFileName);
     Result     :=VarIntegerNull(ReturnValue);
     Exit;
    end;
   Inc(CurrIndex);
