...
type
  ...
  public
   ...
   ///</summary>
   property CheckPoint : LongInt read FCheckPoint;
   ///<summary>
   ...
   ///</summary>
   property DisconnectedSessions : LongInt read FDisconnectedSessions;
   ///<summary>
   ...
   ///<summary>
   ///The ProcessId property specifies the process identifier of the 
   ///service.
   ///Example: 324
   ///</summary>
   ...
   ///has occurred.
   ///</summary>
   property WaitHint : LongInt read FWaitHint;
   ///<summary>
...
{TWin32_TerminalService}
 ...
 constructor TWin32_TerminalService.Create;
 begin
   Create(True);
 end;

 constructor TWin32_TerminalService.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_TerminalService');
 end;
 ...
 begin
    ...
    begin
       ...
       FCheckPoint                          :=VarLongNull(GetPropertyValue('CheckPoint'));
       ...
       FDisconnectedSessions                :=VarLongNull(GetPropertyValue('DisconnectedSessions'));
       ...
       FWaitHint                            :=VarLongNull(GetPropertyValue('WaitHint'));
    end;
 end;
...
begin
 Result:=-1;
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_TerminalService');
...
//not static, OutParams=1, InParams>0
function TWin32_TerminalService.UserControlService(ControlCode : Byte): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
function TWin32_TerminalService.Create(DesktopInteract : Boolean;DisplayName : String;ErrorControl : Byte;LoadOrderGroup : String;LoadOrderGroupDependencies : String;Name : String;PathName : String;ServiceDependencies : String;ServiceType : Byte;StartMode : String;StartName : String;StartPassword : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
begin
  ...
  objSWbemLocator := CreateOleObject('WbemScripting.SWbemLocator');
  objWMIService   := objSWbemLocator.ConnectServer('localhost','root\CIMV2', '','');
  objInvoker      := objWMIService.Get('Win32_TerminalService');
  ...
  ReturnValue     := objWMIService.ExecMethod('Win32_TerminalService', 'Create', objInParams);
end;


//not static, OutParams=1, InParams>0
function TWin32_TerminalService.Change(DesktopInteract : Boolean;DisplayName : String;ErrorControl : Byte;LoadOrderGroup : String;LoadOrderGroupDependencies : String;PathName : String;ServiceDependencies : String;ServiceType : Byte;StartMode : String;StartName : String;StartPassword : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_TerminalService.ChangeStartMode(StartMode : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_TerminalService.SetSecurityDescriptor(Descriptor : Variant): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
