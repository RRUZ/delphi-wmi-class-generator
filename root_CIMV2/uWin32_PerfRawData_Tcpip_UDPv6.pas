...
{TWin32_PerfRawData_Tcpip_UDPv6}
 ...
 constructor TWin32_PerfRawData_Tcpip_UDPv6.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Tcpip_UDPv6.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Tcpip_UDPv6');
 end;
