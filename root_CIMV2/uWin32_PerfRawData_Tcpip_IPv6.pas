...
/// Creation Date 24-12-2010 09:37:46
...
constructor TWin32_PerfRawData_Tcpip_IPv6.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_Tcpip_IPv6');
end;

destructor TWin32_PerfRawData_Tcpip_IPv6.Destroy;
begin
  inherited;
end;
