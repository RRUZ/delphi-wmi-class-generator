...
{TWin32_ControllerHasHub}
 ...
 constructor TWin32_ControllerHasHub.Create;
 begin
   Create(True);
 end;

 constructor TWin32_ControllerHasHub.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_ControllerHasHub');
 end;
