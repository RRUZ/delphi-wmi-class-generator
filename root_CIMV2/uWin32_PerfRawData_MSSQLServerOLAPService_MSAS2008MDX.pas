...
/// Creation Date 24-12-2010 09:37:19
...
constructor TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008MDX.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_MSSQLServerOLAPService_MSAS2008MDX');
end;

destructor TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008MDX.Destroy;
begin
  inherited;
end;
