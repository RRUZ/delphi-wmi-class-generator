...
{TWin32_PerfFormattedData_MSSQLSERVER_SQLServerBrokerDBMTransport}
 ...
 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerBrokerDBMTransport.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerBrokerDBMTransport.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerBrokerDBMTransport');
 end;
