...
{TWin32_IDEControllerDevice}
 ...
 constructor TWin32_IDEControllerDevice.Create;
 begin
   Create(True);
 end;

 constructor TWin32_IDEControllerDevice.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_IDEControllerDevice');
 end;
