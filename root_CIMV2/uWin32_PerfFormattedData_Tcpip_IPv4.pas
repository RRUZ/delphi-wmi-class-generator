...
{TWin32_PerfFormattedData_Tcpip_IPv4}
 ...
 constructor TWin32_PerfFormattedData_Tcpip_IPv4.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_Tcpip_IPv4.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_Tcpip_IPv4');
 end;
