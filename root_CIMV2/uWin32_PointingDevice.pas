...
type
   ///<summary>
   ///The Win32_PointingDevice class represents an input device used to point to and 
   ///select  regions on the display of a Win32 computer system. Any device used to 
   ///manipulate a pointer, or point to the display on a Win32 computer system is a 
  ...
  public
   ...
   ///threshold value.
   ///</summary>
   property DoubleSpeedThreshold : LongInt read FDoubleSpeedThreshold;
   ///<summary>
   ...
   ///<summary>
   ///The HardwareType property indicates the type of hardware type used for the 
   ///Win32 pointing device. 
   ///Example: MICROSOFT PS2 MOUSE
   ///</summary>
   property HardwareType : String read FHardwareType;
   ///<summary>
   ///The InfFileName property indicates the name of the .inf file for the Win32 
   ///pointing device.
   ///Example: ab.inf
   ///</summary>
   ...
   ///<summary>
   ///The NumberOfButtons property indicates the number of buttons on the pointing 
   ///device.
   ///Example: 2
   ///</summary>
   ...
   ///</summary>
   property QuadSpeedThreshold : LongInt read FQuadSpeedThreshold;
   ///<summary>
   ...
   ///</summary>
   property Synch : LongInt read FSynch;
   ///<summary>
...
{TWin32_PointingDevice}
 ...
 constructor TWin32_PointingDevice.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PointingDevice.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PointingDevice');
 end;
 ...
 begin
    ...
    begin
       ...
       FDeviceInterface                     :=VarWordNull(GetPropertyValue('DeviceInterface'));
       FDoubleSpeedThreshold                :=VarLongNull(GetPropertyValue('DoubleSpeedThreshold'));
       FErrorCleared                        :=VarBoolNull(GetPropertyValue('ErrorCleared'));
       FErrorDescription                    :=VarStrNull(GetPropertyValue('ErrorDescription'));
       FHandedness                          :=VarWordNull(GetPropertyValue('Handedness'));
       FHardwareType                        :=VarStrNull(GetPropertyValue('HardwareType'));
       ...
       FNumberOfButtons                     :=VarByteNull(GetPropertyValue('NumberOfButtons'));
       FPNPDeviceID                         :=VarStrNull(GetPropertyValue('PNPDeviceID'));
       FPointingType                        :=VarWordNull(GetPropertyValue('PointingType'));
       ...
       FQuadSpeedThreshold                  :=VarLongNull(GetPropertyValue('QuadSpeedThreshold'));
       FResolution                          :=VarLongNull(GetPropertyValue('Resolution'));
       FSampleRate                          :=VarLongNull(GetPropertyValue('SampleRate'));
       FStatus                              :=VarStrNull(GetPropertyValue('Status'));
       FStatusInfo                          :=VarWordNull(GetPropertyValue('StatusInfo'));
       FSynch                               :=VarLongNull(GetPropertyValue('Synch'));
...
function TWin32_PointingDevice.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_PointingDevice');
