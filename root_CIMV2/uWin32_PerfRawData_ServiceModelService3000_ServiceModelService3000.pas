...
{TWin32_PerfRawData_ServiceModelService3000_ServiceModelService3000}
 ...
 constructor TWin32_PerfRawData_ServiceModelService3000_ServiceModelService3000.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_ServiceModelService3000_ServiceModelService3000.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_ServiceModelService3000_ServiceModelService3000');
 end;
