...
{TWin32_SelfRegModuleAction}
 ...
 constructor TWin32_SelfRegModuleAction.Create;
 begin
   Create(True);
 end;

 constructor TWin32_SelfRegModuleAction.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_SelfRegModuleAction');
 end;
 ...
 begin
    ...
    begin
       ...
       FCost                                :=VarWordNull(GetPropertyValue('Cost'));
...
begin
 Result:=-1;
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_SelfRegModuleAction');
