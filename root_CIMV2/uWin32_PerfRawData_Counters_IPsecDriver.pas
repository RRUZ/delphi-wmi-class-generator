...
{TWin32_PerfRawData_Counters_IPsecDriver}
 ...
 constructor TWin32_PerfRawData_Counters_IPsecDriver.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Counters_IPsecDriver.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Counters_IPsecDriver');
 end;
