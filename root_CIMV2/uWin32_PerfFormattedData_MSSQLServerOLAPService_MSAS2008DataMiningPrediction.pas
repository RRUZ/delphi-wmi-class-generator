...
{TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008DataMiningPrediction}
 ...
 constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008DataMiningPrediction.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008DataMiningPrediction.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008DataMiningPrediction');
 end;
