...
{TWin32_PerfRawData_Counters_WSManQuotaStatistics}
 ...
 constructor TWin32_PerfRawData_Counters_WSManQuotaStatistics.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Counters_WSManQuotaStatistics.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Counters_WSManQuotaStatistics');
 end;
