...
/// Creation Date 13-10-2012 10:54:21
...
constructor TWin32_PerfFormattedData_Counters_IPsecIKEv2IPv6.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_Counters_IPsecIKEv2IPv6');
end;

destructor TWin32_PerfFormattedData_Counters_IPsecIKEv2IPv6.Destroy;
begin
  inherited;
end;
