...
type
  ...
  private
   ...
   FPercentFreeSpace                   : LongInt;
   FPercentFreeSpace_Base              : LongInt;
  ...
  public
   ...
   ///</summary>
   property FreeMegabytes : LongInt read FFreeMegabytes;
   ///<summary>
   ///Free Megabytes displays the unallocated space, in megabytes, on the disk drive 
   ///in megabytes. One megabyte is equal to 1,048,576 bytes.
   ///</summary>
   ...
   ///</summary>
   property PercentFreeSpace : LongInt read FPercentFreeSpace;
   property PercentFreeSpace_Base : LongInt read FPercentFreeSpace_Base;
   ///<summary>
...
{TWin32_PerfRawData_PerfDisk_LogicalDisk}
 ...
 constructor TWin32_PerfRawData_PerfDisk_LogicalDisk.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_PerfDisk_LogicalDisk.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_PerfDisk_LogicalDisk');
 end;
 ...
 begin
    ...
    begin
       ...
       FFreeMegabytes                       :=VarLongNull(GetPropertyValue('FreeMegabytes'));
       ...
       FPercentFreeSpace                    :=VarLongNull(GetPropertyValue('PercentFreeSpace'));
       FPercentFreeSpace_Base               :=VarLongNull(GetPropertyValue('PercentFreeSpace_Base'));
