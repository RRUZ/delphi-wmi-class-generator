...
{TWin32_ShortcutFile}
 ...
 constructor TWin32_ShortcutFile.Create;
 begin
   Create(True);
 end;

 constructor TWin32_ShortcutFile.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_ShortcutFile');
 end;
...
begin
 Result:=-1;
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_ShortcutFile');
...
//not static, OutParams=1, InParams>0
function TWin32_ShortcutFile.ChangeSecurityPermissions(Option : LongInt;SecurityDescriptor : Variant): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_ShortcutFile.Copy(FileName : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_ShortcutFile.Rename(FileName : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_ShortcutFile.GetEffectivePermission(Permissions : LongInt): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
