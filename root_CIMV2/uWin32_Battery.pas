...
type
  ...
  public
   ...
   ///<summary>
   ///The BatteryRechargeTime property indicates the time required to fully charge 
   ///the battery. 
   ///The BatteryRechargeTime property has been deprecated.  There is 
   ///no replacementvalue and this property is now considered obsolete.
   ///</summary>
   property BatteryRechargeTime : LongInt read FBatteryRechargeTime;
   ///<summary>
   ...
   ///<summary>
   ///The ExpectedBatteryLife property indicates the amount of time it takes to 
   ///completely drain the battery after it has been fully charged. 
   ///The 
   ///ExpectedBatteryLife property has been deprecated.  There is no replacementvalue 
   ///and this property is now considered obsolete.
   ///</summary>
   property ExpectedBatteryLife : LongInt read FExpectedBatteryLife;
   ///<summary>
...
{TWin32_Battery}
 ...
 constructor TWin32_Battery.Create;
 begin
   Create(True);
 end;

 constructor TWin32_Battery.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_Battery');
 end;
 ...
 begin
    ...
    begin
       ...
       FBatteryRechargeTime                 :=VarLongNull(GetPropertyValue('BatteryRechargeTime'));
       ...
       FExpectedBatteryLife                 :=VarLongNull(GetPropertyValue('ExpectedBatteryLife'));
...
function TWin32_Battery.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_Battery');
