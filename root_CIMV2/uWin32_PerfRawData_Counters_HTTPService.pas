...
{TWin32_PerfRawData_Counters_HTTPService}
 ...
 constructor TWin32_PerfRawData_Counters_HTTPService.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Counters_HTTPService.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Counters_HTTPService');
 end;
