...
/// Creation Date 22-12-2010 03:57:50
...
{$ENDIF}
  ...
  /// <summary>
  /// The Win32_MemoryArray class represents the properties of the computer system 
  /// memory array and mapped addresses.
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  TWin32_MemoryArray=class(TWmiClass)
  private
    FAccess                             : Word;
  ...
  public
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The DeviceID property contains a string that uniquely identifies the memory array.
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The ErrorGranularity identifies the level where the error can be resolved.
  ...
  {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
  /// <summary>
  /// Return the description for the value of the property TWin32_MemoryArray.Access
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// TWin32_MemoryArray.Availability
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_MemoryArray.ConfigManagerErrorCode
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_MemoryArray.ErrorAccess
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_MemoryArray.ErrorDataOrder
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_MemoryArray.ErrorGranularity
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_MemoryArray.PowerManagementCapabilities
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
...
constructor TWin32_MemoryArray.Create(LoadWmiData : boolean=True);
begin
  SetLength(FAdditionalErrorData,0);
  SetLength(FErrorData,0);
  SetLength(FPowerManagementCapabilities,0);
  inherited Create(LoadWmiData,'root\CIMV2','Win32_MemoryArray');
end;

destructor TWin32_MemoryArray.Destroy;
begin
  SetLength(FAdditionalErrorData,0);
  SetLength(FErrorData,0);
  SetLength(FPowerManagementCapabilities,0);
...
procedure TWin32_MemoryArray.SetCollectionIndex(Index : Integer);
begin
...
function TWin32_MemoryArray.SetPowerState(const PowerState : Word;const Time : TDateTime): Integer;
var
...
//not static, OutParams=1, InParams=0
function TWin32_MemoryArray.Reset: integer;
var
  ReturnValue : OleVariant;
begin
