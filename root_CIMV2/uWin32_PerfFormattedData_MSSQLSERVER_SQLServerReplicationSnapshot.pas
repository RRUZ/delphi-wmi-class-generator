...
constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerReplicationSnapshot.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerReplicationSnapshot');
end;

destructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerReplicationSnapshot.Destroy;
begin
  inherited;
end;
