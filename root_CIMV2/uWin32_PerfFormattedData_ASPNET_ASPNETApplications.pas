...
{TWin32_PerfFormattedData_ASPNET_ASPNETApplications}
 ...
 constructor TWin32_PerfFormattedData_ASPNET_ASPNETApplications.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_ASPNET_ASPNETApplications.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_ASPNET_ASPNETApplications');
 end;
