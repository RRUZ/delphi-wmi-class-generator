...
constructor TWin32_PerfFormattedData_RemoteAccess_RASTotal.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_RemoteAccess_RASTotal');
end;

destructor TWin32_PerfFormattedData_RemoteAccess_RASTotal.Destroy;
begin
  inherited;
end;
