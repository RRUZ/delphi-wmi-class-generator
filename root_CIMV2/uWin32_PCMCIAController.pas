...
type
  ...
  public
   ...
   ///<summary>
   ///The Manufacturer property indicates the name of the PCMCIA controller 
   ///manufacturer.
   ///Example: Acme
   ///</summary>
...
{TWin32_PCMCIAController}
 ...
 constructor TWin32_PCMCIAController.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PCMCIAController.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PCMCIAController');
 end;
...
function TWin32_PCMCIAController.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_PCMCIAController');
