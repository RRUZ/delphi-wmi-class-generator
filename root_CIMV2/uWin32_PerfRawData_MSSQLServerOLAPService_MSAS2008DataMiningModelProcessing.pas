...
{TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008DataMiningModelProcessing}
 ...
 constructor TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008DataMiningModelProcessing.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008DataMiningModelProcessing.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLServerOLAPService_MSAS2008DataMiningModelProcessing');
 end;
