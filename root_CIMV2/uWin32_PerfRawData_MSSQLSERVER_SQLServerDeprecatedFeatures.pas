...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerDeprecatedFeatures}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerDeprecatedFeatures.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerDeprecatedFeatures.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerDeprecatedFeatures');
 end;
 ...
 begin
    ...
    begin
       ...
       FUsage                               :=VarInt64Null(GetPropertyValue('Usage'));
    end;
 end;
