...
/// Creation Date 26-09-2011 03:23:19
/// Namespace root\CIMV2 Class Win32_PerfFormattedData_Counters_ProcessorInformation
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfFormattedData_Counters_ProcessorInformation.asp
/// </summary>
...
unit uWin32_PerfFormattedData_Counters_ProcessorInformation;
...
{$ENDIF}
  ...
  TWin32_PerfFormattedData_Counters_ProcessorInformation=class(TWmiClass)
  private
...
{TWin32_PerfFormattedData_Counters_ProcessorInformation}

constructor TWin32_PerfFormattedData_Counters_ProcessorInformation.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_Counters_ProcessorInformation');
end;

destructor TWin32_PerfFormattedData_Counters_ProcessorInformation.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfFormattedData_Counters_ProcessorInformation.SetCollectionIndex(Index : Integer);
begin
