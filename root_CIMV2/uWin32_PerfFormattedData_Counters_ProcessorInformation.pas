...
{TWin32_PerfFormattedData_Counters_ProcessorInformation}
 ...
 constructor TWin32_PerfFormattedData_Counters_ProcessorInformation.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_Counters_ProcessorInformation.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_Counters_ProcessorInformation');
 end;
