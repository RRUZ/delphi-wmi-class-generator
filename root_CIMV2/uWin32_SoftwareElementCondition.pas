...
{$ENDIF}
  ...
  /// TWin32_SoftwareElementCondition.SoftwareElementState
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_SoftwareElementCondition.TargetOperatingSystem
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
...
constructor TWin32_SoftwareElementCondition.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_SoftwareElementCondition');
end;

destructor TWin32_SoftwareElementCondition.Destroy;
begin
  inherited;
end;
