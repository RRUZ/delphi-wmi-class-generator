...
type
  ...
  private
   ...
   FAverageSemaphoreHoldTime_Base      : LongInt;
   FCaption                            : String;
   FDescription                        : String;
  ...
  public
   ...
   property AverageSemaphoreHoldTime_Base : LongInt read FAverageSemaphoreHoldTime_Base;
   ///<summary>
...
{TWin32_PerfRawData_Counters_Netlogon}
 ...
 constructor TWin32_PerfRawData_Counters_Netlogon.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Counters_Netlogon.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Counters_Netlogon');
 end;
 ...
 begin
    ...
    begin
       ...
       FAverageSemaphoreHoldTime_Base       :=VarLongNull(GetPropertyValue('AverageSemaphoreHoldTime_Base'));
