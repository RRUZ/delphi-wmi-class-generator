...
{TWin32_PerfRawData_ASPNET_ASPNET}
 ...
 constructor TWin32_PerfRawData_ASPNET_ASPNET.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_ASPNET_ASPNET.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_ASPNET_ASPNET');
 end;
