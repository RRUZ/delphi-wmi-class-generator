...
{TWin32_PerfFormattedData_UGatherer_SearchGathererProjects}
 ...
 constructor TWin32_PerfFormattedData_UGatherer_SearchGathererProjects.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_UGatherer_SearchGathererProjects.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_UGatherer_SearchGathererProjects');
 end;
