...
{TWin32_PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle}
 ...
 constructor TWin32_PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle');
 end;
