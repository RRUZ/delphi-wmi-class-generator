...
{TWin32_PerfFormattedData_PerfOS_Memory}
 ...
 constructor TWin32_PerfFormattedData_PerfOS_Memory.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_PerfOS_Memory.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_PerfOS_Memory');
 end;
