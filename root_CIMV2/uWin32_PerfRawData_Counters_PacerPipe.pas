...
{TWin32_PerfRawData_Counters_PacerPipe}
 ...
 constructor TWin32_PerfRawData_Counters_PacerPipe.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Counters_PacerPipe.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Counters_PacerPipe');
 end;
