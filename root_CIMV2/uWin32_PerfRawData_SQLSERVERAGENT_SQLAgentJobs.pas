...
{TWin32_PerfRawData_SQLSERVERAGENT_SQLAgentJobs}
 ...
 constructor TWin32_PerfRawData_SQLSERVERAGENT_SQLAgentJobs.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_SQLSERVERAGENT_SQLAgentJobs.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_SQLSERVERAGENT_SQLAgentJobs');
 end;
 ...
 begin
    ...
    begin
       ...
       FJobsuccessrate_Base                 :=VarInt64Null(GetPropertyValue('Jobsuccessrate_Base'));
