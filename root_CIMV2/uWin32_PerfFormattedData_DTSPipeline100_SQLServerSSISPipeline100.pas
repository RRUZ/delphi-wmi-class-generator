...
/// Creation Date 26-09-2011 03:23:21
/// Namespace root\CIMV2 Class Win32_PerfFormattedData_DTSPipeline100_SQLServerSSISPipeline100
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfFormattedData_DTSPipeline100_SQLServerSSISPipeline100.asp
/// </summary>
...
unit uWin32_PerfFormattedData_DTSPipeline100_SQLServerSSISPipeline100;
...
{$ENDIF}
  ...
  TWin32_PerfFormattedData_DTSPipeline100_SQLServerSSISPipeline100=class(TWmiClass)
  private
...
{TWin32_PerfFormattedData_DTSPipeline100_SQLServerSSISPipeline100}

constructor TWin32_PerfFormattedData_DTSPipeline100_SQLServerSSISPipeline100.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_DTSPipeline100_SQLServerSSISPipeline100');
end;

destructor TWin32_PerfFormattedData_DTSPipeline100_SQLServerSSISPipeline100.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfFormattedData_DTSPipeline100_SQLServerSSISPipeline100.SetCollectionIndex(Index : Integer);
begin
