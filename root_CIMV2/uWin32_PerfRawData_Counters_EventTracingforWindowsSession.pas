...
{TWin32_PerfRawData_Counters_EventTracingforWindowsSession}
 ...
 constructor TWin32_PerfRawData_Counters_EventTracingforWindowsSession.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Counters_EventTracingforWindowsSession.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Counters_EventTracingforWindowsSession');
 end;
