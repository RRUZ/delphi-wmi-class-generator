...
{TWin32_PerfFormattedData_NETFramework_NETCLRSecurity}
 ...
 constructor TWin32_PerfFormattedData_NETFramework_NETCLRSecurity.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_NETFramework_NETCLRSecurity.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_NETFramework_NETCLRSecurity');
 end;
