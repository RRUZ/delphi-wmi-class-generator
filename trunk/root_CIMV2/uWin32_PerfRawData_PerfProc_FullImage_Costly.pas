...
/// Creation Date 17-10-2012 18:19:29
...
constructor TWin32_PerfRawData_PerfProc_FullImage_Costly.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_PerfProc_FullImage_Costly');
end;

destructor TWin32_PerfRawData_PerfProc_FullImage_Costly.Destroy;
begin
  inherited;
end;
