...
// Namespace root\CIMV2 Class Win32_PerfRawData_MSSQLSERVER_SQLServerLatches
// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_MSSQLSERVER_SQLServerLatches.asp
unit uWin32_PerfRawData_MSSQLSERVER_SQLServerLatches;
...
type
   ...
   ///</summary>
  TWin32_PerfRawData_MSSQLSERVER_SQLServerLatches=class(TWmiClass)
  private
   FAverageLatchWaitTimems             : Int64;
   FAverageLatchWaitTimems_Base        : LongInt;
   FCaption                            : String;
   FDescription                        : String;
  ...
  public
   ...
   property AverageLatchWaitTimems_Base : LongInt read FAverageLatchWaitTimems_Base;
   ///<summary>
...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerLatches}

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerLatches.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerLatches.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerLatches');
 end;

 procedure TWin32_PerfRawData_MSSQLSERVER_SQLServerLatches.SetCollectionIndex(Index: Integer);
 begin
    if (Index>=0) and (Index<=FWmiCollection.Count-1) then
    begin
       FWmiCollectionIndex:=Index;
       FAverageLatchWaitTimems              :=VarInt64Null(GetPropertyValue('AverageLatchWaitTimems'));
       FAverageLatchWaitTimems_Base         :=VarLongNull(GetPropertyValue('AverageLatchWaitTimems_Base'));
