...
{TWin32_PerfFormattedData_Counters_HTTPServiceUrlGroups}
 ...
 constructor TWin32_PerfFormattedData_Counters_HTTPServiceUrlGroups.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_Counters_HTTPServiceUrlGroups.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_Counters_HTTPServiceUrlGroups');
 end;
