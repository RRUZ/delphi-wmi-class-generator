...
/// Creation Date 02-04-2011 16:32:14
...
{$ENDIF}
  ...
  /// TWin32_TemperatureProbe.Availability
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_TemperatureProbe.ConfigManagerErrorCode
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_TemperatureProbe.PowerManagementCapabilities
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_TemperatureProbe.StatusInfo
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
...
constructor TWin32_TemperatureProbe.Create(LoadWmiData : boolean=True);
begin
  SetLength(FPowerManagementCapabilities,0);
  inherited Create(LoadWmiData,'root\CIMV2','Win32_TemperatureProbe');
end;

destructor TWin32_TemperatureProbe.Destroy;
begin
  SetLength(FPowerManagementCapabilities,0);
  inherited;
end;
...
function TWin32_TemperatureProbe.SetPowerState(const PowerState : Word;const Time : TDateTime): Integer;
var
