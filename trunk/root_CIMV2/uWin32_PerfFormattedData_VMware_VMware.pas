...
/// Creation Date 22-12-2010 05:33:51
...
constructor TWin32_PerfFormattedData_VMware_VMware.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_VMware_VMware');
end;

destructor TWin32_PerfFormattedData_VMware_VMware.Destroy;
begin
  inherited;
end;
