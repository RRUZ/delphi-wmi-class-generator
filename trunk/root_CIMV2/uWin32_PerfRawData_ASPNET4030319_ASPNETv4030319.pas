...
constructor TWin32_PerfRawData_ASPNET4030319_ASPNETv4030319.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_ASPNET4030319_ASPNETv4030319');
end;

destructor TWin32_PerfRawData_ASPNET4030319_ASPNETv4030319.Destroy;
begin
  inherited;
end;
