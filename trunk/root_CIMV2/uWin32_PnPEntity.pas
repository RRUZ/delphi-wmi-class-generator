...
/// Creation Date 23-02-2011 23:39:10
/// Namespace root\CIMV2 Class Win32_PnPEntity
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PnPEntity.asp
/// </summary>
...
{$ENDIF}
  ...
  /// <summary>
  /// The Win32_PnPEntity class represents the properties of a Plug and Play device. 
  /// Plug and Play entities are shown as entries in the Device Manager located in 
  /// the Control Panel.
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  TWin32_PnPEntity=class(TWmiClass)
  private
    FAvailability                       : Word;
    FCaption                            : String;
    FClassGuid                          : String;
    FCompatibleID                       : TStrings;
  ...
  public
   ...
   /// matches one of a device's hardware IDs, it uses compatible IDs to locate an INF file.
   /// </summary>
   {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
   property CompatibleID : TStrings read FCompatibleID;
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// List of Hardware IDs associated with the device. A hardware ID is a vendor-
   /// defined identification string that Setup uses to match a device to an INF file.
   /// </summary>
   {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
   property HardwareID : TStrings read FHardwareID;
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The Manufacturer property contains the name of the manufacturer of the Plug and Play device.
   /// Example: Acme
   /// </summary>
   {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The Service property contains the name of the service that supports this Plug and Play device. See also: Win32_SystemDriverPNPEntity class.
   /// Example: atapi
   /// </summary>
   {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_PnPEntity.ConfigManagerErrorCode
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_PnPEntity.PowerManagementCapabilities
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  function GetPowerManagementCapabilitiesAsString(const APropValue:Word) : string;
  {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
  /// <summary>
  /// Return the description for the value of the property TWin32_PnPEntity.StatusInfo
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
...
constructor TWin32_PnPEntity.Create(LoadWmiData : boolean=True);
begin
  FCompatibleID:=TStringList.Create;
  FHardwareID:=TStringList.Create;
  SetLength(FPowerManagementCapabilities,0);
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PnPEntity');
end;

destructor TWin32_PnPEntity.Destroy;
begin
  FCompatibleID.Free;
  FHardwareID.Free;
  SetLength(FPowerManagementCapabilities,0);
...
procedure TWin32_PnPEntity.SetCollectionIndex(Index : Integer);
begin
  ...
  begin
    ...
    VarArrayToArray(inherited Value['CompatibleID'],FCompatibleID);
    ...
    VarArrayToArray(inherited Value['HardwareID'],FHardwareID);
    ...
    FService                          := VarStrNull(inherited Value['Service']);
...
function TWin32_PnPEntity.SetPowerState(const PowerState : Word;const Time : TDateTime): Integer;
var
...
//not static, OutParams=1, InParams=0
function TWin32_PnPEntity.Reset: integer;
var
  ReturnValue : OleVariant;
begin
