...
{TWin32_PerfRawData_Counters_IPsecIKEv2IPv6}
 ...
 constructor TWin32_PerfRawData_Counters_IPsecIKEv2IPv6.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Counters_IPsecIKEv2IPv6.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Counters_IPsecIKEv2IPv6');
 end;
