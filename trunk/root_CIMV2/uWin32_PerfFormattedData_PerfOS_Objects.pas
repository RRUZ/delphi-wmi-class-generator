...
constructor TWin32_PerfFormattedData_PerfOS_Objects.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_PerfOS_Objects');
end;

destructor TWin32_PerfFormattedData_PerfOS_Objects.Destroy;
begin
  inherited;
end;
