...
/// Creation Date 12-10-2012 22:47:01
/// Namespace root\CIMV2 Class Win32_InfraredDevice
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_InfraredDevice.asp
/// </summary>
...
{$ENDIF}
  ...
  /// <summary>
  /// The Win32_InfraredDevice class represents the capabilities and management of an 
  /// infrared device.
  /// </summary>
  {$IFNDEF OLD_DELPHI}{$ENDREGION}{$ENDIF}
  TWin32_InfraredDevice=class(TWmiClass)
  private
    FAvailability                       : Word;
    FCaption                            : String;
  ...
  public
   ...
   {$IFNDEF OLD_DELPHI}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The DeviceID property contains a string uniquely identifying the infrared 
   ...
   {$IFNDEF OLD_DELPHI}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The Manufacturer property indicates the name of the manufacturer of the infrared device .
   /// Example: Acme
   /// </summary>
   {$IFNDEF OLD_DELPHI}{$ENDREGION}{$ENDIF}
  ...
  /// TWin32_InfraredDevice.Availability
  /// </summary>
  {$IFNDEF OLD_DELPHI}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_InfraredDevice.ConfigManagerErrorCode
  /// </summary>
  {$IFNDEF OLD_DELPHI}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_InfraredDevice.PowerManagementCapabilities
  /// </summary>
  {$IFNDEF OLD_DELPHI}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_InfraredDevice.ProtocolSupported
  /// </summary>
  {$IFNDEF OLD_DELPHI}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_InfraredDevice.StatusInfo
  /// </summary>
  {$IFNDEF OLD_DELPHI}{$ENDREGION}{$ENDIF}
...
{TWin32_InfraredDevice}

constructor TWin32_InfraredDevice.Create(LoadWmiData : boolean=True);
begin
  SetLength(FPowerManagementCapabilities,0);
  inherited Create(LoadWmiData,'root\CIMV2','Win32_InfraredDevice');
end;

destructor TWin32_InfraredDevice.Destroy;
begin
  SetLength(FPowerManagementCapabilities,0);
  inherited;
end;

procedure TWin32_InfraredDevice.SetCollectionIndex(Index : Integer);
begin
...
function TWin32_InfraredDevice.SetPowerState(const PowerState : Word;const Time : TDateTime): Integer;
var
...
//not static, OutParams=1, InParams=0
function TWin32_InfraredDevice.Reset: integer;
var
  ReturnValue : OleVariant;
begin
