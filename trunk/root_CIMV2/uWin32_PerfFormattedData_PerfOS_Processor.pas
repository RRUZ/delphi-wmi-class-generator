...
{TWin32_PerfFormattedData_PerfOS_Processor}
 ...
 constructor TWin32_PerfFormattedData_PerfOS_Processor.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_PerfOS_Processor.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_PerfOS_Processor');
 end;
