...
{TWin32_PerfRawData_Counters_Synchronization}
 ...
 constructor TWin32_PerfRawData_Counters_Synchronization.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Counters_Synchronization.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Counters_Synchronization');
 end;
