...
{TWin32_PerfRawData_Counters_PerProcessorNetworkActivityCycles}
 ...
 constructor TWin32_PerfRawData_Counters_PerProcessorNetworkActivityCycles.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Counters_PerProcessorNetworkActivityCycles.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Counters_PerProcessorNetworkActivityCycles');
 end;
