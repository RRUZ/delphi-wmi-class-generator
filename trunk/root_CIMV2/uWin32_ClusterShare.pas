...
{TWin32_ClusterShare}
 ...
 constructor TWin32_ClusterShare.Create;
 begin
   Create(True);
 end;

 constructor TWin32_ClusterShare.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_ClusterShare');
 end;
...
function TWin32_ClusterShare.Create(Access : Variant;Description : String;MaximumAllowed : LongInt;Name : String;Password : String;Path : String;&Type : LongInt): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.Get('Win32_ClusterShare');
  ...
  ReturnValue     := objWMIService.ExecMethod('Win32_ClusterShare', 'Create', objInParams);
end;


//not static, OutParams=1, InParams>0
function TWin32_ClusterShare.SetShareInfo(Access : Variant;Description : String;MaximumAllowed : LongInt): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
begin
  ...
  objSWbemLocator := CreateOleObject('WbemScripting.SWbemLocator');
  objWMIService   := objSWbemLocator.ConnectServer('localhost','root\CIMV2', '','');
  objInvoker      := objWMIService.InstancesOf('Win32_ClusterShare');
