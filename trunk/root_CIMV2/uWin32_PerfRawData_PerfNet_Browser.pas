...
{TWin32_PerfRawData_PerfNet_Browser}
 ...
 constructor TWin32_PerfRawData_PerfNet_Browser.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_PerfNet_Browser.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_PerfNet_Browser');
 end;
