...
{TCIM_DataFile}
 ...
 constructor TCIM_DataFile.Create;
 begin
   Create(True);
 end;

 constructor TCIM_DataFile.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','CIM_DataFile');
 end;
...
begin
 Result:=-1;
  ...
  objInvoker      := objWMIService.InstancesOf('CIM_DataFile');
...
//not static, OutParams=1, InParams>0
function TCIM_DataFile.ChangeSecurityPermissions(Option : LongInt;SecurityDescriptor : Variant): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TCIM_DataFile.Copy(FileName : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TCIM_DataFile.Rename(FileName : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TCIM_DataFile.GetEffectivePermission(Permissions : LongInt): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
