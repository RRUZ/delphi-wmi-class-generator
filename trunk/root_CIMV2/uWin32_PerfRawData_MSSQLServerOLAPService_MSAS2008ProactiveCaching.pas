...
{TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProactiveCaching}
 ...
 constructor TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProactiveCaching.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProactiveCaching.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProactiveCaching');
 end;
