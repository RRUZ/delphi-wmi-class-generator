...
/// Creation Date 24-12-2010 09:37:21
/// Namespace root\CIMV2 Class Win32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProactiveCaching
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProactiveCaching.asp
/// </summary>
...
unit uWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProactiveCaching;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProactiveCaching=class(TWmiClass)
  private
    FCaption                            : String;
    FDescription                        : String;
...
{TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProactiveCaching}

constructor TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProactiveCaching.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProactiveCaching');
end;

destructor TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProactiveCaching.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProactiveCaching.SetCollectionIndex(Index : Integer);
begin
