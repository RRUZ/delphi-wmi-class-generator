...
{TWin32_PerfFormattedData_Counters_TeredoServer}
 ...
 constructor TWin32_PerfFormattedData_Counters_TeredoServer.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_Counters_TeredoServer.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_Counters_TeredoServer');
 end;
