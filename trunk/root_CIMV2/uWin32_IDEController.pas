...
type
   ///<summary>
   ///The Win32_IDEController class manages the capabilities of an IDE controller 
   ///device.
   ///</summary>
  ...
  public
   ...
   ///<summary>
   ///The DeviceID property indicates a string that uniquely identifies the IDE 
   ...
   ///<summary>
   ///The Manufacturer property indicates the manufacturer of the IDE controller 
   ///device.
   ///</summary>
...
{TWin32_IDEController}
 ...
 constructor TWin32_IDEController.Create;
 begin
   Create(True);
 end;

 constructor TWin32_IDEController.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_IDEController');
 end;
...
function TWin32_IDEController.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_IDEController');
