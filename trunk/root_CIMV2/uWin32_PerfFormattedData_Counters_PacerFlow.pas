...
constructor TWin32_PerfFormattedData_Counters_PacerFlow.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_Counters_PacerFlow');
end;

destructor TWin32_PerfFormattedData_Counters_PacerFlow.Destroy;
begin
  inherited;
end;
