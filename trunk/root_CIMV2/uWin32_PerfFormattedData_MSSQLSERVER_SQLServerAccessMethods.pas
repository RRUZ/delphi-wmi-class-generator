...
{TWin32_PerfFormattedData_MSSQLSERVER_SQLServerAccessMethods}
 ...
 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerAccessMethods.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerAccessMethods.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerAccessMethods');
 end;
