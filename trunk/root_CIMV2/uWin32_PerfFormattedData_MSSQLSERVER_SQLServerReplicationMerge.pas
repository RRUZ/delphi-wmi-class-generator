...
constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerReplicationMerge.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerReplicationMerge');
end;

destructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerReplicationMerge.Destroy;
begin
  inherited;
end;
