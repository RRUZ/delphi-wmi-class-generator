...
/// Creation Date 02-04-2011 16:31:25
/// Namespace root\CIMV2 Class Win32_PerfRawData_Counters_IPsecIKEv1IPv6
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_Counters_IPsecIKEv1IPv6.asp
/// </summary>
...
unit uWin32_PerfRawData_Counters_IPsecIKEv1IPv6;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_Counters_IPsecIKEv1IPv6=class(TWmiClass)
  private
...
{TWin32_PerfRawData_Counters_IPsecIKEv1IPv6}

constructor TWin32_PerfRawData_Counters_IPsecIKEv1IPv6.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_Counters_IPsecIKEv1IPv6');
end;

destructor TWin32_PerfRawData_Counters_IPsecIKEv1IPv6.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_Counters_IPsecIKEv1IPv6.SetCollectionIndex(Index : Integer);
begin
