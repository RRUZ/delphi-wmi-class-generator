...
{TWin32_PerfRawData_UGTHRSVC_SearchGatherer}
 ...
 constructor TWin32_PerfRawData_UGTHRSVC_SearchGatherer.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_UGTHRSVC_SearchGatherer.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_UGTHRSVC_SearchGatherer');
 end;
