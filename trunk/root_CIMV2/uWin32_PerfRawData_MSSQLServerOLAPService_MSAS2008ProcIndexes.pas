...
{TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProcIndexes}
 ...
 constructor TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProcIndexes.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProcIndexes.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLServerOLAPService_MSAS2008ProcIndexes');
 end;
