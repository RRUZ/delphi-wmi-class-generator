...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerExecStatistics}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerExecStatistics.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerExecStatistics.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerExecStatistics');
 end;
