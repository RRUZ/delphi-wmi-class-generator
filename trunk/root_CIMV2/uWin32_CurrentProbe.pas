...
/// Namespace root\CIMV2 Class Win32_CurrentProbe
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_CurrentProbe.asp
/// </summary>
...
{$ENDIF}
  ...
  /// <summary>
  /// The Win32_CurrentProbe class represents the properties of a current monitoring 
  /// sensor (ammeter).
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  TWin32_CurrentProbe=class(TWmiClass)
  private
    FAccuracy                           : Integer;
    FAvailability                       : Word;
    FCaption                            : String;
  ...
  public
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The DeviceID property contains a string identifying the current probe.
   /// </summary>
   {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// TWin32_CurrentProbe.Availability
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_CurrentProbe.ConfigManagerErrorCode
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_CurrentProbe.PowerManagementCapabilities
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_CurrentProbe.StatusInfo
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
...
constructor TWin32_CurrentProbe.Create(LoadWmiData : boolean=True);
begin
  SetLength(FPowerManagementCapabilities,0);
  inherited Create(LoadWmiData,'root\CIMV2','Win32_CurrentProbe');
end;

destructor TWin32_CurrentProbe.Destroy;
begin
  SetLength(FPowerManagementCapabilities,0);
  inherited;
end;

procedure TWin32_CurrentProbe.SetCollectionIndex(Index : Integer);
begin
...
function TWin32_CurrentProbe.SetPowerState(const PowerState : Word;const Time : TDateTime): Integer;
var
...
//not static, OutParams=1, InParams=0
function TWin32_CurrentProbe.Reset: integer;
var
  ReturnValue : OleVariant;
begin
