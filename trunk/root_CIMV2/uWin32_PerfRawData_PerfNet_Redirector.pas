...
{TWin32_PerfRawData_PerfNet_Redirector}
 ...
 constructor TWin32_PerfRawData_PerfNet_Redirector.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_PerfNet_Redirector.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_PerfNet_Redirector');
 end;
