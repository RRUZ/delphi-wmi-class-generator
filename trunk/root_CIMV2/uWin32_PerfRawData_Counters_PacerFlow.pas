...
{TWin32_PerfRawData_Counters_PacerFlow}
 ...
 constructor TWin32_PerfRawData_Counters_PacerFlow.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Counters_PacerFlow.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Counters_PacerFlow');
 end;
