...
{TWin32_PerfFormattedData_ASPNET4030319_ASPNETv4030319}
 ...
 constructor TWin32_PerfFormattedData_ASPNET4030319_ASPNETv4030319.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_ASPNET4030319_ASPNETv4030319.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_ASPNET4030319_ASPNETv4030319');
 end;
