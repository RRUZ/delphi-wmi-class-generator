...
{TWin32_PerfRawData_SMSvcHost3000_SMSvcHost3000}
 ...
 constructor TWin32_PerfRawData_SMSvcHost3000_SMSvcHost3000.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_SMSvcHost3000_SMSvcHost3000.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_SMSvcHost3000_SMSvcHost3000');
 end;
