...
/// Creation Date 02-04-2011 16:31:12
...
constructor TWin32_PerfFormattedData_SMSvcHost3000_SMSvcHost3000.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_SMSvcHost3000_SMSvcHost3000');
end;

destructor TWin32_PerfFormattedData_SMSvcHost3000_SMSvcHost3000.Destroy;
begin
  inherited;
end;
