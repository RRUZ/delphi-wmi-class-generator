...
/// Creation Date 22-12-2010 03:57:38
...
{$ENDIF}
  ...
  /// <summary>
  /// The Win32_Directory class represents a directory entry on a Win32 computer system. Directory is a type of file that logically groups data files 'contained' in it and provides path information for the grouped files.
  /// Example: C:\TEMP.
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  TWin32_Directory=class(TWmiClass)
  private
  ...
  /// TWin32_Directory.TakeOwnerShip
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the result of the function 
  /// TWin32_Directory.ChangeSecurityPermissions
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  function GetResultChangeSecurityPermissionsAsString(const ReturnValue:Integer) : string;
  {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
  /// <summary>
  /// Return the description for the result of the function TWin32_Directory.Copy
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  function GetResultCopyAsString(const ReturnValue:Integer) : string;
  {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
  /// <summary>
  /// Return the description for the result of the function TWin32_Directory.Rename
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  function GetResultRenameAsString(const ReturnValue:Integer) : string;
  {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
  /// <summary>
  /// Return the description for the result of the function TWin32_Directory.Delete
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  function GetResultDeleteAsString(const ReturnValue:Integer) : string;
  {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
  /// <summary>
  /// Return the description for the result of the function TWin32_Directory.Compress
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the result of the function 
  /// TWin32_Directory.TakeOwnerShipEx
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the result of the function 
  /// TWin32_Directory.ChangeSecurityPermissionsEx
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  function GetResultChangeSecurityPermissionsExAsString(const ReturnValue:Integer) : string;
  {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
  /// <summary>
  /// Return the description for the result of the function TWin32_Directory.CopyEx
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  function GetResultCopyExAsString(const ReturnValue:Integer) : string;
  {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
  /// <summary>
  /// Return the description for the result of the function TWin32_Directory.DeleteEx
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
...
constructor TWin32_Directory.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_Directory');
end;

destructor TWin32_Directory.Destroy;
begin
  inherited;
end;

procedure TWin32_Directory.SetCollectionIndex(Index : Integer);
begin
...
function TWin32_Directory.TakeOwnerShip: integer;
var
...
//not static, OutParams=1, InParams>0
function TWin32_Directory.ChangeSecurityPermissions(const Option : Cardinal;const SecurityDescriptor : OleVariant): Integer;
var
  ReturnValue : OleVariant;
begin
...
//not static, OutParams=1, InParams>0
function TWin32_Directory.Copy(const FileName : String): Integer;
var
  ReturnValue : OleVariant;
begin
...
//not static, OutParams=1, InParams>0
function TWin32_Directory.Rename(const FileName : String): Integer;
var
  ReturnValue : OleVariant;
begin
...
//not static, OutParams=1, InParams=0
function TWin32_Directory.Delete: integer;
var
  ReturnValue : OleVariant;
begin
...
//not static, OutParams=1, InParams=0
function TWin32_Directory.Compress: integer;
var
  ReturnValue : OleVariant;
begin
...
//not static, OutParams=1, InParams=0
function TWin32_Directory.Uncompress: integer;
var
  ReturnValue : OleVariant;
begin
...
//not static, OutParams=1, InParams>0
function TWin32_Directory.GetEffectivePermission(const Permissions : Cardinal): Integer;
var
  ReturnValue : OleVariant;
begin
