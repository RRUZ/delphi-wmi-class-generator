...
type
  ...
  private
   ...
   FMonitorType                        : String;
   FName                               : String;
   FPixelsPerXLogicalInch              : LongInt;
   FPixelsPerYLogicalInch              : LongInt;
   FPNPDeviceID                        : String;
  ...
  public
   ...
   ///</summary>
   property Bandwidth : LongInt read FBandwidth;
   ///<summary>
   ...
   ///<summary>
   ///The DeviceID property contains a string that uniquely identifies a desktop 
   ///monitor.
   ///Example: DesktopMonitor1
   ///</summary>
   property DeviceID : String read FDeviceID;
   ///<summary>
   ///The type of desktop monitor or CRT. For example, multiscan color or monochrome 
   ///monitors (values 2 or 3, respectively) can be indicated in this property.
   ///</summary>
   ...
   ///<summary>
   ///The MonitorManufacturer property indicates the name of the monitor 
   ///manufacturer. 
   ///Example: NEC
   ///</summary>
   ...
   ///<summary>
   ///The PixelsPerXLogicalInch property indicates the resolution along the X axis 
   ///(horizontal direction) of the monitor.
   ///</summary>
   property PixelsPerXLogicalInch : LongInt read FPixelsPerXLogicalInch;
   ///<summary>
   ///The PixelsPerYLogicalInch property indicates the resolution along the Y axis 
   ///(vertical direction) of the monitor.
   ///</summary>
   property PixelsPerYLogicalInch : LongInt read FPixelsPerYLogicalInch;
   ///<summary>
...
{TWin32_DesktopMonitor}
 ...
 constructor TWin32_DesktopMonitor.Create;
 begin
   Create(True);
 end;

 constructor TWin32_DesktopMonitor.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_DesktopMonitor');
 end;
 ...
 begin
    ...
    begin
       ...
       FBandwidth                           :=VarLongNull(GetPropertyValue('Bandwidth'));
       ...
       FDisplayType                         :=VarWordNull(GetPropertyValue('DisplayType'));
       ...
       FIsLocked                            :=VarBoolNull(GetPropertyValue('IsLocked'));
       FLastErrorCode                       :=VarLongNull(GetPropertyValue('LastErrorCode'));
       FMonitorManufacturer                 :=VarStrNull(GetPropertyValue('MonitorManufacturer'));
       FMonitorType                         :=VarStrNull(GetPropertyValue('MonitorType'));
       FName                                :=VarStrNull(GetPropertyValue('Name'));
       FPixelsPerXLogicalInch               :=VarLongNull(GetPropertyValue('PixelsPerXLogicalInch'));
       FPixelsPerYLogicalInch               :=VarLongNull(GetPropertyValue('PixelsPerYLogicalInch'));
       ...
       FScreenHeight                        :=VarLongNull(GetPropertyValue('ScreenHeight'));
       FScreenWidth                         :=VarLongNull(GetPropertyValue('ScreenWidth'));
...
function TWin32_DesktopMonitor.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_DesktopMonitor');
