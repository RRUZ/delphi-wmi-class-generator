...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerDatabaseMirroring}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerDatabaseMirroring.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerDatabaseMirroring.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerDatabaseMirroring');
 end;
