...
{TWin32_PerfRawData_SQLSERVERAGENT_SQLAgentJobSteps}
 ...
 constructor TWin32_PerfRawData_SQLSERVERAGENT_SQLAgentJobSteps.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_SQLSERVERAGENT_SQLAgentJobSteps.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_SQLSERVERAGENT_SQLAgentJobSteps');
 end;
