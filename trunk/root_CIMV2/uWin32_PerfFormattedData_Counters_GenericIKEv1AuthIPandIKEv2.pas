...
{TWin32_PerfFormattedData_Counters_GenericIKEv1AuthIPandIKEv2}
 ...
 constructor TWin32_PerfFormattedData_Counters_GenericIKEv1AuthIPandIKEv2.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_Counters_GenericIKEv1AuthIPandIKEv2.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_Counters_GenericIKEv1AuthIPandIKEv2');
 end;
