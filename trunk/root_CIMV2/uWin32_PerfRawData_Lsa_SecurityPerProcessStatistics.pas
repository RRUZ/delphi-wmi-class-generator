...
{TWin32_PerfRawData_Lsa_SecurityPerProcessStatistics}
 ...
 constructor TWin32_PerfRawData_Lsa_SecurityPerProcessStatistics.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Lsa_SecurityPerProcessStatistics.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Lsa_SecurityPerProcessStatistics');
 end;
