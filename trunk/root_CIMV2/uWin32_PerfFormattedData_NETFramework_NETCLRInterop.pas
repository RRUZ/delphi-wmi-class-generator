...
{TWin32_PerfFormattedData_NETFramework_NETCLRInterop}
 ...
 constructor TWin32_PerfFormattedData_NETFramework_NETCLRInterop.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_NETFramework_NETCLRInterop.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_NETFramework_NETCLRInterop');
 end;
