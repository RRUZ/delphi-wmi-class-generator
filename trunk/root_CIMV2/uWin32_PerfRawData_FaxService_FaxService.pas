...
{TWin32_PerfRawData_FaxService_FaxService}
 ...
 constructor TWin32_PerfRawData_FaxService_FaxService.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_FaxService_FaxService.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_FaxService_FaxService');
 end;
