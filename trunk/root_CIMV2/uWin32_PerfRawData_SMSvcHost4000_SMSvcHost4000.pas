...
{TWin32_PerfRawData_SMSvcHost4000_SMSvcHost4000}
 ...
 constructor TWin32_PerfRawData_SMSvcHost4000_SMSvcHost4000.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_SMSvcHost4000_SMSvcHost4000.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_SMSvcHost4000_SMSvcHost4000');
 end;
