...
/// Creation Date 12-10-2012 22:47:19
/// Namespace root\CIMV2 Class Win32_PerfFormattedData_Counters_IPsecIKEv1IPv6
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfFormattedData_Counters_IPsecIKEv1IPv6.asp
/// </summary>
...
unit uWin32_PerfFormattedData_Counters_IPsecIKEv1IPv6;
...
{$ENDIF}
  ...
  /// <summary>
  /// IPsec IKEv1 IPv6 is the set of Internet Protocol security (IPsec) Internet Key 
  /// Exchange version 1 (IKEv1) counters that apply to traffic and connections over 
  /// Internet Protocol version 6.
  /// </summary>
  {$IFNDEF OLD_DELPHI}{$ENDREGION}{$ENDIF}
  TWin32_PerfFormattedData_Counters_IPsecIKEv1IPv6=class(TWmiClass)
  private
...
{TWin32_PerfFormattedData_Counters_IPsecIKEv1IPv6}

constructor TWin32_PerfFormattedData_Counters_IPsecIKEv1IPv6.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_Counters_IPsecIKEv1IPv6');
end;

destructor TWin32_PerfFormattedData_Counters_IPsecIKEv1IPv6.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfFormattedData_Counters_IPsecIKEv1IPv6.SetCollectionIndex(Index : Integer);
begin
