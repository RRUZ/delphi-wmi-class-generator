...
/// Namespace root\CIMV2 Class Win32_PerfRawData_Counters_IPsecIKEv2IPv4
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_Counters_IPsecIKEv2IPv4.asp
/// </summary>
...
unit uWin32_PerfRawData_Counters_IPsecIKEv2IPv4;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_Counters_IPsecIKEv2IPv4=class(TWmiClass)
  private
...
{TWin32_PerfRawData_Counters_IPsecIKEv2IPv4}

constructor TWin32_PerfRawData_Counters_IPsecIKEv2IPv4.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_Counters_IPsecIKEv2IPv4');
end;

destructor TWin32_PerfRawData_Counters_IPsecIKEv2IPv4.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_Counters_IPsecIKEv2IPv4.SetCollectionIndex(Index : Integer);
begin
