...
{TWin32_PerfRawData_PeerNameResolutionProtocol_PeerNameResolutionProtocol}
 ...
 constructor TWin32_PerfRawData_PeerNameResolutionProtocol_PeerNameResolutionProtocol.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_PeerNameResolutionProtocol_PeerNameResolutionProtocol.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_PeerNameResolutionProtocol_PeerNameResolutionProtocol');
 end;
