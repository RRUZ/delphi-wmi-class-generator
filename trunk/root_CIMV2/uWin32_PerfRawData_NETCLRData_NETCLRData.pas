...
{TWin32_PerfRawData_NETCLRData_NETCLRData}
 ...
 constructor TWin32_PerfRawData_NETCLRData_NETCLRData.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_NETCLRData_NETCLRData.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_NETCLRData_NETCLRData');
 end;
