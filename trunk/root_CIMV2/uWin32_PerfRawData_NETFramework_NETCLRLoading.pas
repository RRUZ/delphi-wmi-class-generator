...
{TWin32_PerfRawData_NETFramework_NETCLRLoading}
 ...
 constructor TWin32_PerfRawData_NETFramework_NETCLRLoading.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_NETFramework_NETCLRLoading.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_NETFramework_NETCLRLoading');
 end;
