...
{TWin32_PerfFormattedData_WindowsWorkflowFoundation3000_WindowsWorkflowFoundation}
 ...
 constructor TWin32_PerfFormattedData_WindowsWorkflowFoundation3000_WindowsWorkflowFoundation.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_WindowsWorkflowFoundation3000_WindowsWorkflowFoundation.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_WindowsWorkflowFoundation3000_WindowsWorkflowFoundation');
 end;
