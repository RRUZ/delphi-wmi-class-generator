...
{TWin32_PerfRawData_Tcpip_TCPv4}
 ...
 constructor TWin32_PerfRawData_Tcpip_TCPv4.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Tcpip_TCPv4.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Tcpip_TCPv4');
 end;
