...
{TWin32_PerfRawData_ASPNET_ASPNETApplications}
 ...
 constructor TWin32_PerfRawData_ASPNET_ASPNETApplications.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_ASPNET_ASPNETApplications.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_ASPNET_ASPNETApplications');
 end;
