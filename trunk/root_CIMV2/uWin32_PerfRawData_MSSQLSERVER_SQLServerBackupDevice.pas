...
constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerBackupDevice.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerBackupDevice');
end;

destructor TWin32_PerfRawData_MSSQLSERVER_SQLServerBackupDevice.Destroy;
begin
  inherited;
end;
