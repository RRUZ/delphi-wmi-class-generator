...
{TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Cache}
 ...
 constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Cache.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Cache.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Cache');
 end;
