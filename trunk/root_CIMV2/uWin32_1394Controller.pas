...
/// Creation Date 24-12-2010 09:35:27
/// Namespace root\CIMV2 Class Win32_1394Controller
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_1394Controller.asp
/// </summary>
...
{$ENDIF}
  ...
  /// <summary>
  /// The Win32_1394Controller class represents the capabilities and management of a 
  /// 1394 controller.  IEEE 1394 is a specification for a high speed serial bus.
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  TWin32_1394Controller=class(TWmiClass)
  private
    FAvailability                       : Word;
    FCaption                            : String;
  ...
  public
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The DeviceID property contains a string uniquely identifying the 1394 
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The Manufacturer property indicates the name of the manufacturer of the 1394 controller. 
   /// Example: Acme
   /// </summary>
   {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// TWin32_1394Controller.Availability
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_1394Controller.ConfigManagerErrorCode
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_1394Controller.PowerManagementCapabilities
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_1394Controller.ProtocolSupported
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_1394Controller.StatusInfo
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
...
{TWin32_1394Controller}

constructor TWin32_1394Controller.Create(LoadWmiData : boolean=True);
begin
  SetLength(FPowerManagementCapabilities,0);
  inherited Create(LoadWmiData,'root\CIMV2','Win32_1394Controller');
end;

destructor TWin32_1394Controller.Destroy;
begin
  SetLength(FPowerManagementCapabilities,0);
  inherited;
end;

procedure TWin32_1394Controller.SetCollectionIndex(Index : Integer);
begin
...
function TWin32_1394Controller.SetPowerState(const PowerState : Word;const Time : TDateTime): Integer;
var
...
//not static, OutParams=1, InParams=0
function TWin32_1394Controller.Reset: integer;
var
  ReturnValue : OleVariant;
begin
