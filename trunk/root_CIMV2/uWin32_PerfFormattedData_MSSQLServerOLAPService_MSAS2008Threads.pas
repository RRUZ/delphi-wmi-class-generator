...
/// Creation Date 24-12-2010 09:36:24
...
constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Threads.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Threads');
end;

destructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Threads.Destroy;
begin
  inherited;
end;
