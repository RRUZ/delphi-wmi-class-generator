...
/// Namespace root\CIMV2 Class Win32_PerfFormattedData_MSSQLSERVER_SQLServerBufferNode
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfFormattedData_MSSQLSERVER_SQLServerBufferNode.asp
/// </summary>
...
unit uWin32_PerfFormattedData_MSSQLSERVER_SQLServerBufferNode;
...
{$ENDIF}
  ...
  TWin32_PerfFormattedData_MSSQLSERVER_SQLServerBufferNode=class(TWmiClass)
  private
    FCaption                            : String;
...
{TWin32_PerfFormattedData_MSSQLSERVER_SQLServerBufferNode}

constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerBufferNode.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerBufferNode');
end;

destructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerBufferNode.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfFormattedData_MSSQLSERVER_SQLServerBufferNode.SetCollectionIndex(Index : Integer);
begin
