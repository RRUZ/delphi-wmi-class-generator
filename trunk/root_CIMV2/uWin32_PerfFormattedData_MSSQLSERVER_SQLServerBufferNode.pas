...
{TWin32_PerfFormattedData_MSSQLSERVER_SQLServerBufferNode}
 ...
 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerBufferNode.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerBufferNode.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerBufferNode');
 end;
