...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerReplicationMerge}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerReplicationMerge.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerReplicationMerge.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerReplicationMerge');
 end;
