...
{TWin32_PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000}
 ...
 constructor TWin32_PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000');
 end;
