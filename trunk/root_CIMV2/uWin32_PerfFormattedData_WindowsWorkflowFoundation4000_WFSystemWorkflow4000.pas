...
/// Namespace root\CIMV2 Class Win32_PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000.asp
/// </summary>
...
unit uWin32_PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000;
...
{$ENDIF}
  ...
  TWin32_PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000=class(TWmiClass)
  private
    FCaption                            : String;
    FDescription                        : String;
...
{TWin32_PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000}

constructor TWin32_PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000');
end;

destructor TWin32_PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000.SetCollectionIndex(Index : Integer);
begin
