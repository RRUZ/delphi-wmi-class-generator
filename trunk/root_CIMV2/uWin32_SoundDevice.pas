...
type
  ...
  public
   ...
   ///<summary>
   ///The DMABufferSize property indicates the size of the Direct Memory Access 
   ///buffer.
   ///Example: 4
   ///</summary>
   ...
   ///<summary>
   ///The MPU401Address property indicates the starting I/O address assigned to the 
   ///MPU-401 port of the sound device.
   ///Example: 300
   ///</summary>
   property MPU401Address : LongInt read FMPU401Address;
   ///<summary>
   ...
   ///<summary>
   ///The ProductName property indicates the product name of the sound 
   ///device.
...
{TWin32_SoundDevice}
 ...
 constructor TWin32_SoundDevice.Create;
 begin
   Create(True);
 end;

 constructor TWin32_SoundDevice.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_SoundDevice');
 end;
 ...
 begin
    ...
    begin
       ...
       FDMABufferSize                       :=VarWordNull(GetPropertyValue('DMABufferSize'));
       ...
       FMPU401Address                       :=VarLongNull(GetPropertyValue('MPU401Address'));
...
function TWin32_SoundDevice.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_SoundDevice');
