...
type
  ...
  private
   ...
   FHttpWebRequestsAverageLifetime_Base : LongInt;
   FHttpWebRequestsAverageQueueTime    : Int64;
   FHttpWebRequestsAverageQueueTime_Base : LongInt;
  ...
  public
   ...
   property HttpWebRequestsAverageLifetime_Base : LongInt read FHttpWebRequestsAverageLifetime_Base;
   ///<summary>
   ...
   property HttpWebRequestsAverageQueueTime_Base : LongInt read FHttpWebRequestsAverageQueueTime_Base;
   ///<summary>
...
{TWin32_PerfRawData_NETCLRNetworking4000_NETCLRNetworking4000}
 ...
 constructor TWin32_PerfRawData_NETCLRNetworking4000_NETCLRNetworking4000.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_NETCLRNetworking4000_NETCLRNetworking4000.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_NETCLRNetworking4000_NETCLRNetworking4000');
 end;
 ...
 begin
    ...
    begin
       ...
       FHttpWebRequestsAverageLifetime_Base  :=VarLongNull(GetPropertyValue('HttpWebRequestsAverageLifetime_Base'));
       FHttpWebRequestsAverageQueueTime     :=VarInt64Null(GetPropertyValue('HttpWebRequestsAverageQueueTime'));
       FHttpWebRequestsAverageQueueTime_Base  :=VarLongNull(GetPropertyValue('HttpWebRequestsAverageQueueTime_Base'));
