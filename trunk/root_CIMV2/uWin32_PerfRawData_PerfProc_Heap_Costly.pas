...
{TWin32_PerfRawData_PerfProc_Heap_Costly}
 ...
 constructor TWin32_PerfRawData_PerfProc_Heap_Costly.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_PerfProc_Heap_Costly.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_PerfProc_Heap_Costly');
 end;
