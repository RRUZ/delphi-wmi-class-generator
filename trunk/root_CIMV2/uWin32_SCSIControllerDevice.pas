...
{TWin32_SCSIControllerDevice}
 ...
 constructor TWin32_SCSIControllerDevice.Create;
 begin
   Create(True);
 end;

 constructor TWin32_SCSIControllerDevice.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_SCSIControllerDevice');
 end;
