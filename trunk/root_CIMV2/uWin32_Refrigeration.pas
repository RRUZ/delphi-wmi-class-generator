...
{TWin32_Refrigeration}
 ...
 constructor TWin32_Refrigeration.Create;
 begin
   Create(True);
 end;

 constructor TWin32_Refrigeration.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_Refrigeration');
 end;
...
function TWin32_Refrigeration.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_Refrigeration');
