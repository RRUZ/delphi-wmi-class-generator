...
{TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008Threads}
 ...
 constructor TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008Threads.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLServerOLAPService_MSAS2008Threads.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLServerOLAPService_MSAS2008Threads');
 end;
