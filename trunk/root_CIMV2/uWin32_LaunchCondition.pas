...
type
   ///<summary>
   ///The LaunchCondition class is used by the LaunchConditions action. It contains a 
   ///list of conditions, all of which must be satisfied for the action to succeed.
   ///</summary>
  ...
  public
   ...
   ///<summary>
   ///A condition that must evaluate to TRUE for installation to begin.
   ///</summary>
...
{TWin32_LaunchCondition}
 ...
 constructor TWin32_LaunchCondition.Create;
 begin
   Create(True);
 end;

 constructor TWin32_LaunchCondition.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_LaunchCondition');
 end;
...
begin
 Result:=-1;
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_LaunchCondition');
