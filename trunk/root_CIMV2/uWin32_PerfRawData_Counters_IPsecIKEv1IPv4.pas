...
/// Creation Date 26-09-2011 03:24:00
...
unit uWin32_PerfRawData_Counters_IPsecIKEv1IPv4;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_Counters_IPsecIKEv1IPv4=class(TWmiClass)
  private
...
{TWin32_PerfRawData_Counters_IPsecIKEv1IPv4}

constructor TWin32_PerfRawData_Counters_IPsecIKEv1IPv4.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_Counters_IPsecIKEv1IPv4');
end;

destructor TWin32_PerfRawData_Counters_IPsecIKEv1IPv4.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_Counters_IPsecIKEv1IPv4.SetCollectionIndex(Index : Integer);
begin
