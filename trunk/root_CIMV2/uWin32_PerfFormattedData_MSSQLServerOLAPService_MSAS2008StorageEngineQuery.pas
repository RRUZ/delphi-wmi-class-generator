...
{TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008StorageEngineQuery}
 ...
 constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008StorageEngineQuery.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008StorageEngineQuery.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008StorageEngineQuery');
 end;
