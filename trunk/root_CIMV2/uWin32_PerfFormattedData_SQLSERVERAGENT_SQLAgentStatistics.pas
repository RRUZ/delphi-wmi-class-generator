...
constructor TWin32_PerfFormattedData_SQLSERVERAGENT_SQLAgentStatistics.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_SQLSERVERAGENT_SQLAgentStatistics');
end;

destructor TWin32_PerfFormattedData_SQLSERVERAGENT_SQLAgentStatistics.Destroy;
begin
  inherited;
end;
