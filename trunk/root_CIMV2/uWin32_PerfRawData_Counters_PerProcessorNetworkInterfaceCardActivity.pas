...
{TWin32_PerfRawData_Counters_PerProcessorNetworkInterfaceCardActivity}
 ...
 constructor TWin32_PerfRawData_Counters_PerProcessorNetworkInterfaceCardActivity.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Counters_PerProcessorNetworkInterfaceCardActivity.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Counters_PerProcessorNetworkInterfaceCardActivity');
 end;
