...
{TWin32_PerfFormattedData_MSSQLSERVER_SQLServerMemoryManager}
 ...
 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerMemoryManager.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerMemoryManager.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerMemoryManager');
 end;
