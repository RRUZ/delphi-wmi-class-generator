...
{TWin32_PerfFormattedData_MSSQLSERVER_SQLServerResourcePoolStats}
 ...
 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerResourcePoolStats.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerResourcePoolStats.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerResourcePoolStats');
 end;
