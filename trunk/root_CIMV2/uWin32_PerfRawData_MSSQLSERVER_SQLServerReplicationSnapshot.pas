...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerReplicationSnapshot}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerReplicationSnapshot.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerReplicationSnapshot.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerReplicationSnapshot');
 end;
