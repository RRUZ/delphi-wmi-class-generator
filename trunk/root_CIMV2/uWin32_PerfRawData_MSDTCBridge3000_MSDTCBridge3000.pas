...
/// Creation Date 02-04-2011 16:31:30
...
unit uWin32_PerfRawData_MSDTCBridge3000_MSDTCBridge3000;
...
{TWin32_PerfRawData_MSDTCBridge3000_MSDTCBridge3000}

constructor TWin32_PerfRawData_MSDTCBridge3000_MSDTCBridge3000.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_MSDTCBridge3000_MSDTCBridge3000');
end;

destructor TWin32_PerfRawData_MSDTCBridge3000_MSDTCBridge3000.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_MSDTCBridge3000_MSDTCBridge3000.SetCollectionIndex(Index : Integer);
begin
