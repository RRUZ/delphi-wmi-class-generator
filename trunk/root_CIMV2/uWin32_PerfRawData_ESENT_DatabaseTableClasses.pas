...
{TWin32_PerfRawData_ESENT_DatabaseTableClasses}
 ...
 constructor TWin32_PerfRawData_ESENT_DatabaseTableClasses.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_ESENT_DatabaseTableClasses.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_ESENT_DatabaseTableClasses');
 end;
