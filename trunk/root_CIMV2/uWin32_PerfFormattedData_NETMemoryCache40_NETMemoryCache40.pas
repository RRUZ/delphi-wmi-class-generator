...
{TWin32_PerfFormattedData_NETMemoryCache40_NETMemoryCache40}
 ...
 constructor TWin32_PerfFormattedData_NETMemoryCache40_NETMemoryCache40.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_NETMemoryCache40_NETMemoryCache40.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_NETMemoryCache40_NETMemoryCache40');
 end;
