...
{TWin32_PerfFormattedData_PerfNet_ServerWorkQueues}
 ...
 constructor TWin32_PerfFormattedData_PerfNet_ServerWorkQueues.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_PerfNet_ServerWorkQueues.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_PerfNet_ServerWorkQueues');
 end;
