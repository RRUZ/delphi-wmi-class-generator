...
type
  ...
  public
   ...
   property PercentTimeinGC_Base : LongInt read FPercentTimeinGC_Base;
   ///<summary>
...
{TWin32_PerfRawData_NETFramework_NETCLRMemory}
 ...
 constructor TWin32_PerfRawData_NETFramework_NETCLRMemory.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_NETFramework_NETCLRMemory.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_NETFramework_NETCLRMemory');
 end;
 ...
 begin
    ...
    begin
       ...
       FPercentTimeinGC_Base                :=VarLongNull(GetPropertyValue('PercentTimeinGC_Base'));
