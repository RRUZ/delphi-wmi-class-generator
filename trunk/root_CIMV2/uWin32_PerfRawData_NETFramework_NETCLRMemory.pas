...
/// Creation Date 12-10-2012 22:47:55
/// Namespace root\CIMV2 Class Win32_PerfRawData_NETFramework_NETCLRMemory
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_NETFramework_NETCLRMemory.asp
/// </summary>
...
unit uWin32_PerfRawData_NETFramework_NETCLRMemory;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_NETFramework_NETCLRMemory=class(TWmiClass)
  private
    ...
    FPercentTimeinGC_Base               : Cardinal;
    FProcessID                          : Cardinal;
  ...
  public
   ...
   property PercentTimeinGC_Base : Cardinal read FPercentTimeinGC_Base;
   {$IFNDEF OLD_DELPHI}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
...
{TWin32_PerfRawData_NETFramework_NETCLRMemory}

constructor TWin32_PerfRawData_NETFramework_NETCLRMemory.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_NETFramework_NETCLRMemory');
end;

destructor TWin32_PerfRawData_NETFramework_NETCLRMemory.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_NETFramework_NETCLRMemory.SetCollectionIndex(Index : Integer);
begin
  ...
  begin
    ...
    FPercentTimeinGC_Base                    := VarCardinalNull(inherited Value['PercentTimeinGC_Base']);
