...
{TWin32_DiskDriveToDiskPartition}
 ...
 constructor TWin32_DiskDriveToDiskPartition.Create;
 begin
   Create(True);
 end;

 constructor TWin32_DiskDriveToDiskPartition.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_DiskDriveToDiskPartition');
 end;
