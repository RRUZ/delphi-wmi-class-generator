...
/// Creation Date 13-10-2012 10:54:29
/// Namespace root\CIMV2 Class Win32_PerfFormattedData_Outlook_Outlook
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfFormattedData_Outlook_Outlook.asp
/// </summary>
...
unit uWin32_PerfFormattedData_Outlook_Outlook;
...
{$ENDIF}
  ...
  TWin32_PerfFormattedData_Outlook_Outlook=class(TWmiClass)
  private
    FCaption                            : String;
...
{TWin32_PerfFormattedData_Outlook_Outlook}

constructor TWin32_PerfFormattedData_Outlook_Outlook.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_Outlook_Outlook');
end;

destructor TWin32_PerfFormattedData_Outlook_Outlook.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfFormattedData_Outlook_Outlook.SetCollectionIndex(Index : Integer);
begin
