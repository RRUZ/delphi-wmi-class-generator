...
/// Creation Date 22-12-2010 03:58:15
...
{$ENDIF}
  ...
  public
   ...
   {$IFDEF UNDEF}{$REGION 'Documentation'}{$ENDIF}
   /// <summary>
   /// The OSAutoDiscovered property indicates whether the parallel port was automatically detected by the operating system or by other means (such as being manually added through the Control Panel).
  ...
  /// TWin32_ParallelPort.Availability
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_ParallelPort.Capabilities
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_ParallelPort.ConfigManagerErrorCode
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_ParallelPort.PowerManagementCapabilities
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_ParallelPort.ProtocolSupported
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_ParallelPort.StatusInfo
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
...
Result:='';
  case APropValue of
    0 : Result:='Unknown';
    1 : Result:='Other';
    2 : Result:='XT/AT Compatible';
    3 : Result:='PS/2 Compatible';
    4 : Result:='ECP';
    5 : Result:='EPP';
    6 : Result:='PC-98';
    7 : Result:='PC-98-Hireso';
    8 : Result:='PC-H98';
  end;
end;
