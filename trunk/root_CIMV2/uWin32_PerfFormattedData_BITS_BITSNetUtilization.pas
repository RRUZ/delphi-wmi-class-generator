...
{TWin32_PerfFormattedData_BITS_BITSNetUtilization}
 ...
 constructor TWin32_PerfFormattedData_BITS_BITSNetUtilization.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_BITS_BITSNetUtilization.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_BITS_BITSNetUtilization');
 end;
