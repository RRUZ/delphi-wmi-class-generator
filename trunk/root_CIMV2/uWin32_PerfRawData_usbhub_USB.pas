...
type
  ...
  private
   ...
   FAvgBytesPerTransfer_Base           : LongInt;
   FAvgmslatencyforISOtransfers        : Int64;
   FAvgmslatencyforISOtransfers_Base   : LongInt;
  ...
  public
   ...
   property AvgBytesPerTransfer_Base : LongInt read FAvgBytesPerTransfer_Base;
   ///<summary>
   ...
   property AvgmslatencyforISOtransfers_Base : LongInt read FAvgmslatencyforISOtransfers_Base;
   ///<summary>
...
{TWin32_PerfRawData_usbhub_USB}
 ...
 constructor TWin32_PerfRawData_usbhub_USB.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_usbhub_USB.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_usbhub_USB');
 end;
 ...
 begin
    ...
    begin
       ...
       FAvgBytesPerTransfer_Base            :=VarLongNull(GetPropertyValue('AvgBytesPerTransfer_Base'));
       FAvgmslatencyforISOtransfers         :=VarInt64Null(GetPropertyValue('AvgmslatencyforISOtransfers'));
       FAvgmslatencyforISOtransfers_Base    :=VarLongNull(GetPropertyValue('AvgmslatencyforISOtransfers_Base'));
