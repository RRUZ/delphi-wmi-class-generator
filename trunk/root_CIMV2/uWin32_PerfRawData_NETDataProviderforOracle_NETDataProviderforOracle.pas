...
/// Creation Date 02-04-2011 16:31:42
/// Namespace root\CIMV2 Class Win32_PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle.asp
/// </summary>
...
unit uWin32_PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle=class(TWmiClass)
  private
    FCaption                            : String;
    FDescription                        : String;
...
{TWin32_PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle}

constructor TWin32_PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle');
end;

destructor TWin32_PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle.SetCollectionIndex(Index : Integer);
begin
