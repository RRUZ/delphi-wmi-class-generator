...
{TWin32_PerfFormattedData_MSDTCBridge4000_MSDTCBridge4000}
 ...
 constructor TWin32_PerfFormattedData_MSDTCBridge4000_MSDTCBridge4000.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSDTCBridge4000_MSDTCBridge4000.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSDTCBridge4000_MSDTCBridge4000');
 end;
