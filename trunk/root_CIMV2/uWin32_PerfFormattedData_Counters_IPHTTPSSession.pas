...
{TWin32_PerfFormattedData_Counters_IPHTTPSSession}
 ...
 constructor TWin32_PerfFormattedData_Counters_IPHTTPSSession.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_Counters_IPHTTPSSession.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_Counters_IPHTTPSSession');
 end;
