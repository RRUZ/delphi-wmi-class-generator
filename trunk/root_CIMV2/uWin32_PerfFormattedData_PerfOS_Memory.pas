...
/// Creation Date 22-12-2010 03:59:32
/// Namespace root\CIMV2 Class Win32_PerfFormattedData_PerfOS_Memory
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfFormattedData_PerfOS_Memory.asp
/// </summary>
...
unit uWin32_PerfFormattedData_PerfOS_Memory;
...
{$ENDIF}
  ...
  TWin32_PerfFormattedData_PerfOS_Memory=class(TWmiClass)
  private
...
{TWin32_PerfFormattedData_PerfOS_Memory}

constructor TWin32_PerfFormattedData_PerfOS_Memory.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_PerfOS_Memory');
end;

destructor TWin32_PerfFormattedData_PerfOS_Memory.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfFormattedData_PerfOS_Memory.SetCollectionIndex(Index : Integer);
begin
