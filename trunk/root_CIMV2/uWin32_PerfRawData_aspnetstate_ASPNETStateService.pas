...
{TWin32_PerfRawData_aspnetstate_ASPNETStateService}
 ...
 constructor TWin32_PerfRawData_aspnetstate_ASPNETStateService.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_aspnetstate_ASPNETStateService.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_aspnetstate_ASPNETStateService');
 end;
