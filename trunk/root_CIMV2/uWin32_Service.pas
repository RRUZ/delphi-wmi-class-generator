...
{TWin32_Service}
 ...
 constructor TWin32_Service.Create;
 begin
   Create(True);
 end;

 constructor TWin32_Service.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_Service');
 end;
...
begin
 Result:=-1;
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_Service');
...
//not static, OutParams=1, InParams>0
function TWin32_Service.UserControlService(ControlCode : Byte): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
function TWin32_Service.Create(DesktopInteract : Boolean;DisplayName : String;ErrorControl : Byte;LoadOrderGroup : String;LoadOrderGroupDependencies : String;Name : String;PathName : String;ServiceDependencies : String;ServiceType : Byte;StartMode : String;StartName : String;StartPassword : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
begin
  ...
  objSWbemLocator := CreateOleObject('WbemScripting.SWbemLocator');
  objWMIService   := objSWbemLocator.ConnectServer('localhost','root\CIMV2', '','');
  objInvoker      := objWMIService.Get('Win32_Service');
  ...
  ReturnValue     := objWMIService.ExecMethod('Win32_Service', 'Create', objInParams);
end;


//not static, OutParams=1, InParams>0
function TWin32_Service.Change(DesktopInteract : Boolean;DisplayName : String;ErrorControl : Byte;LoadOrderGroup : String;LoadOrderGroupDependencies : String;PathName : String;ServiceDependencies : String;ServiceType : Byte;StartMode : String;StartName : String;StartPassword : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_Service.ChangeStartMode(StartMode : String): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
...
//not static, OutParams=1, InParams>0
function TWin32_Service.SetSecurityDescriptor(Descriptor : Variant): Integer;
var
  objSWbemLocator : OLEVariant;
  objWMIService   : OLEVariant;
  objInvoker      : OLEVariant;
