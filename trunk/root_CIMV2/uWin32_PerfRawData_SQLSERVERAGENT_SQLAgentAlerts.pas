...
{TWin32_PerfRawData_SQLSERVERAGENT_SQLAgentAlerts}
 ...
 constructor TWin32_PerfRawData_SQLSERVERAGENT_SQLAgentAlerts.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_SQLSERVERAGENT_SQLAgentAlerts.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_SQLSERVERAGENT_SQLAgentAlerts');
 end;
