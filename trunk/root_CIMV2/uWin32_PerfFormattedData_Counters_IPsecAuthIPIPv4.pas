...
{TWin32_PerfFormattedData_Counters_IPsecAuthIPIPv4}
 ...
 constructor TWin32_PerfFormattedData_Counters_IPsecAuthIPIPv4.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_Counters_IPsecAuthIPIPv4.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_Counters_IPsecAuthIPIPv4');
 end;
