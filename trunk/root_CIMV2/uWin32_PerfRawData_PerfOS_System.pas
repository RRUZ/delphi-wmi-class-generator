...
type
  ...
  private
   ...
   FPercentRegistryQuotaInUse_Base     : LongInt;
   FProcesses                          : LongInt;
  ...
  public
   ...
   property PercentRegistryQuotaInUse_Base : LongInt read FPercentRegistryQuotaInUse_Base;
   ///<summary>
...
{TWin32_PerfRawData_PerfOS_System}
 ...
 constructor TWin32_PerfRawData_PerfOS_System.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_PerfOS_System.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_PerfOS_System');
 end;
 ...
 begin
    ...
    begin
       ...
       FPercentRegistryQuotaInUse_Base      :=VarLongNull(GetPropertyValue('PercentRegistryQuotaInUse_Base'));
