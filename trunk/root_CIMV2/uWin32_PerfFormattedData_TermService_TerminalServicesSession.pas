...
{TWin32_PerfFormattedData_TermService_TerminalServicesSession}
 ...
 constructor TWin32_PerfFormattedData_TermService_TerminalServicesSession.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_TermService_TerminalServicesSession.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_TermService_TerminalServicesSession');
 end;
