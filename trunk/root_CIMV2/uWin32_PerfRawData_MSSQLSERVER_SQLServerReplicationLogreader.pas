...
/// Namespace root\CIMV2 Class Win32_PerfRawData_MSSQLSERVER_SQLServerReplicationLogreader
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfRawData_MSSQLSERVER_SQLServerReplicationLogreader.asp
/// </summary>
...
unit uWin32_PerfRawData_MSSQLSERVER_SQLServerReplicationLogreader;
...
{$ENDIF}
  ...
  TWin32_PerfRawData_MSSQLSERVER_SQLServerReplicationLogreader=class(TWmiClass)
  private
    FCaption                            : String;
    FDescription                        : String;
...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerReplicationLogreader}

constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerReplicationLogreader.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerReplicationLogreader');
end;

destructor TWin32_PerfRawData_MSSQLSERVER_SQLServerReplicationLogreader.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfRawData_MSSQLSERVER_SQLServerReplicationLogreader.SetCollectionIndex(Index : Integer);
begin
