...
/// Creation Date 23-02-2011 23:38:03
...
constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerReplicationAgents.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerReplicationAgents');
end;

destructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerReplicationAgents.Destroy;
begin
  inherited;
end;
