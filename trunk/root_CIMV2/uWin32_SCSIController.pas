...
type
   ///<summary>
   ///The Win32_SCSIController class represents a SCSI controller on a Win32 
   ///system.
  ...
  public
   ...
   ///</summary>
   property ControllerTimeouts : LongInt read FControllerTimeouts;
   ///<summary>
   ...
   ///<summary>
   ///The DeviceMap property indicates the order in which devices are listed with 
   ///this SCSI controller. 
   ///The DeviceMap property has been deprecated.  There is no 
   ///replacementvalue and this property is now considered obsolete.
   ///</summary>
   property DeviceMap : String read FDeviceMap;
   ///<summary>
   ///The DriverName property indicates the driver file name of the SCSI 
   ///controller.
   ///Example: Adaptec
   ///</summary>
   ...
   ///<summary>
   ///The HardwareVersion property indicates the hardware version number of the SCSI 
   ///controller.
   ///Example: 1.25
   ///</summary>
   property HardwareVersion : String read FHardwareVersion;
   ///<summary>
   ///The Index property indicates the index number of the SCSI controller in the 
   ///system registry.
   ///Example: 0.
   ///</summary>
   ...
   ///<summary>
   ///The Manufacturer property indicates the name of the SCSI controller 
   ///manufacturer.
   ///Example: Adaptec
   ///</summary>
   ...
   ///</summary>
   property MaxDataWidth : LongInt read FMaxDataWidth;
   ///<summary>
...
{TWin32_SCSIController}
 ...
 constructor TWin32_SCSIController.Create;
 begin
   Create(True);
 end;

 constructor TWin32_SCSIController.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_SCSIController');
 end;
 ...
 begin
    ...
    begin
       ...
       FHardwareVersion                     :=VarStrNull(GetPropertyValue('HardwareVersion'));
       ...
       FMaxDataWidth                        :=VarLongNull(GetPropertyValue('MaxDataWidth'));
       FMaxNumberControlled                 :=VarLongNull(GetPropertyValue('MaxNumberControlled'));
       FMaxTransferRate                     :=VarInt64Null(GetPropertyValue('MaxTransferRate'));
       ...
       FProtectionManagement                :=VarWordNull(GetPropertyValue('ProtectionManagement'));
...
function TWin32_SCSIController.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_SCSIController');
