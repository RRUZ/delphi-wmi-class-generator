...
{TWin32_PerfFormattedData_AuthorizationManager_AuthorizationManagerApplications}
 ...
 constructor TWin32_PerfFormattedData_AuthorizationManager_AuthorizationManagerApplications.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_AuthorizationManager_AuthorizationManagerApplications.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_AuthorizationManager_AuthorizationManagerApplications');
 end;
