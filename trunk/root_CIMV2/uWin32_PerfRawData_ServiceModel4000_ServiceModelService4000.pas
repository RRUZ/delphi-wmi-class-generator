...
type
  ...
  private
   ...
   FName                               : String;
   FPercentOfMaxConcurrentCalls        : LongInt;
   FPercentOfMaxConcurrentCalls_Base   : LongInt;
   FPercentOfMaxConcurrentInstances    : LongInt;
   FPercentOfMaxConcurrentInstances_Base : LongInt;
   FPercentOfMaxConcurrentSessions     : LongInt;
   FPercentOfMaxConcurrentSessions_Base : LongInt;
  ...
  public
   ...
   ///</summary>
   property PercentOfMaxConcurrentCalls : LongInt read FPercentOfMaxConcurrentCalls;
   property PercentOfMaxConcurrentCalls_Base : LongInt read FPercentOfMaxConcurrentCalls_Base;
   ///<summary>
   ...
   ///</summary>
   property PercentOfMaxConcurrentInstances : LongInt read FPercentOfMaxConcurrentInstances;
   property PercentOfMaxConcurrentInstances_Base : LongInt read FPercentOfMaxConcurrentInstances_Base;
   ///<summary>
   ...
   ///</summary>
   property PercentOfMaxConcurrentSessions : LongInt read FPercentOfMaxConcurrentSessions;
   property PercentOfMaxConcurrentSessions_Base : LongInt read FPercentOfMaxConcurrentSessions_Base;
   ///<summary>
...
{TWin32_PerfRawData_ServiceModel4000_ServiceModelService4000}
 ...
 constructor TWin32_PerfRawData_ServiceModel4000_ServiceModelService4000.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_ServiceModel4000_ServiceModelService4000.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_ServiceModel4000_ServiceModelService4000');
 end;
 ...
 begin
    ...
    begin
       ...
       FPercentOfMaxConcurrentCalls         :=VarLongNull(GetPropertyValue('PercentOfMaxConcurrentCalls'));
       FPercentOfMaxConcurrentCalls_Base    :=VarLongNull(GetPropertyValue('PercentOfMaxConcurrentCalls_Base'));
       FPercentOfMaxConcurrentInstances     :=VarLongNull(GetPropertyValue('PercentOfMaxConcurrentInstances'));
       FPercentOfMaxConcurrentInstances_Base  :=VarLongNull(GetPropertyValue('PercentOfMaxConcurrentInstances_Base'));
       FPercentOfMaxConcurrentSessions      :=VarLongNull(GetPropertyValue('PercentOfMaxConcurrentSessions'));
       FPercentOfMaxConcurrentSessions_Base  :=VarLongNull(GetPropertyValue('PercentOfMaxConcurrentSessions_Base'));
