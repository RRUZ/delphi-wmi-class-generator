...
constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerGeneralStatistics.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerGeneralStatistics');
end;

destructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerGeneralStatistics.Destroy;
begin
  inherited;
end;
