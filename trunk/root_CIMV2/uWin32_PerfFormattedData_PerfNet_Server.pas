...
{TWin32_PerfFormattedData_PerfNet_Server}
 ...
 constructor TWin32_PerfFormattedData_PerfNet_Server.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_PerfNet_Server.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_PerfNet_Server');
 end;
