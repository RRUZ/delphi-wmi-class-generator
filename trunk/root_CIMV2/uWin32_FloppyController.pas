...
type
  ...
  public
   ...
   ///<summary>
   ///The Manufacturer property indicates the name of the manufacturer (of the floppy 
   ///controller). 
   ///Example: Acme.
   ///</summary>
...
{TWin32_FloppyController}
 ...
 constructor TWin32_FloppyController.Create;
 begin
   Create(True);
 end;

 constructor TWin32_FloppyController.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_FloppyController');
 end;
...
function TWin32_FloppyController.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_FloppyController');
