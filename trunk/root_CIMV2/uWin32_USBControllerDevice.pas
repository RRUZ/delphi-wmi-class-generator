...
{TWin32_USBControllerDevice}
 ...
 constructor TWin32_USBControllerDevice.Create;
 begin
   Create(True);
 end;

 constructor TWin32_USBControllerDevice.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_USBControllerDevice');
 end;
