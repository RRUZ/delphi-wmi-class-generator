...
{TWin32_PerfFormattedData_Spooler_PrintQueue}
 ...
 constructor TWin32_PerfFormattedData_Spooler_PrintQueue.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_Spooler_PrintQueue.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_Spooler_PrintQueue');
 end;
