...
{TWin32_PerfRawData_PerfProc_JobObjectDetails}
 ...
 constructor TWin32_PerfRawData_PerfProc_JobObjectDetails.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_PerfProc_JobObjectDetails.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_PerfProc_JobObjectDetails');
 end;
