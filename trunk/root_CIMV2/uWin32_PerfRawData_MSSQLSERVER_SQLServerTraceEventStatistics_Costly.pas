...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerTraceEventStatistics_Costly}

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerTraceEventStatistics_Costly.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerTraceEventStatistics_Costly.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerTraceEventStatistics_Costly');
 end;

 procedure TWin32_PerfRawData_MSSQLSERVER_SQLServerTraceEventStatistics_Costly.SetCollectionIndex(Index: Integer);
 begin
