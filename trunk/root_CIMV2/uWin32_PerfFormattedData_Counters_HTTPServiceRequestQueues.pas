...
{TWin32_PerfFormattedData_Counters_HTTPServiceRequestQueues}
 ...
 constructor TWin32_PerfFormattedData_Counters_HTTPServiceRequestQueues.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_Counters_HTTPServiceRequestQueues.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_Counters_HTTPServiceRequestQueues');
 end;
