...
{TWin32_PerfRawData_Counters_EventTracingforWindows}
 ...
 constructor TWin32_PerfRawData_Counters_EventTracingforWindows.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_Counters_EventTracingforWindows.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_Counters_EventTracingforWindows');
 end;
