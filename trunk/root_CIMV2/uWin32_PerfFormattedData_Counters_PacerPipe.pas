...
constructor TWin32_PerfFormattedData_Counters_PacerPipe.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_Counters_PacerPipe');
end;

destructor TWin32_PerfFormattedData_Counters_PacerPipe.Destroy;
begin
  inherited;
end;
