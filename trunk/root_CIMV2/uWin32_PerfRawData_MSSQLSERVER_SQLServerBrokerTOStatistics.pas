...
type
  ...
  private
   ...
   FAvgLengthofBatchedWrites_Base      : LongInt;
   FAvgTimeBetweenBatchesms            : Int64;
   FAvgTimeBetweenBatchesms_Base       : LongInt;
   FAvgTimetoWriteBatchms              : Int64;
   FAvgTimetoWriteBatchms_Base         : LongInt;
   FCaption                            : String;
   FDescription                        : String;
  ...
  public
   ...
   property AvgLengthofBatchedWrites_Base : LongInt read FAvgLengthofBatchedWrites_Base;
   ///<summary>
   ...
   property AvgTimeBetweenBatchesms_Base : LongInt read FAvgTimeBetweenBatchesms_Base;
   ///<summary>
   ///Average time to save a Transmission Object batch.
   ///</summary>
   property AvgTimetoWriteBatchms : Int64 read FAvgTimetoWriteBatchms;
   property AvgTimetoWriteBatchms_Base : LongInt read FAvgTimetoWriteBatchms_Base;
   ///<summary>
...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerBrokerTOStatistics}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerBrokerTOStatistics.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerBrokerTOStatistics.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerBrokerTOStatistics');
 end;
 ...
 begin
    ...
    begin
       ...
       FAvgLengthofBatchedWrites_Base       :=VarLongNull(GetPropertyValue('AvgLengthofBatchedWrites_Base'));
       FAvgTimeBetweenBatchesms             :=VarInt64Null(GetPropertyValue('AvgTimeBetweenBatchesms'));
       FAvgTimeBetweenBatchesms_Base        :=VarLongNull(GetPropertyValue('AvgTimeBetweenBatchesms_Base'));
       FAvgTimetoWriteBatchms               :=VarInt64Null(GetPropertyValue('AvgTimetoWriteBatchms'));
       FAvgTimetoWriteBatchms_Base          :=VarLongNull(GetPropertyValue('AvgTimetoWriteBatchms_Base'));
