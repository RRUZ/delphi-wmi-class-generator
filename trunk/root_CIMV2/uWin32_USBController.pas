...
{TWin32_USBController}
 ...
 constructor TWin32_USBController.Create;
 begin
   Create(True);
 end;

 constructor TWin32_USBController.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_USBController');
 end;
...
function TWin32_USBController.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_USBController');
