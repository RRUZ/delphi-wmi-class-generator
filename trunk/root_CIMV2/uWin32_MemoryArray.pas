...
type
  ...
  public
   ...
   ///<summary>
   ///The ErrorGranularity identifies the level where the error can be 
   ///resolved.
...
{TWin32_MemoryArray}
 ...
 constructor TWin32_MemoryArray.Create;
 begin
   Create(True);
 end;

 constructor TWin32_MemoryArray.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_MemoryArray');
 end;
...
function TWin32_MemoryArray.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_MemoryArray');
