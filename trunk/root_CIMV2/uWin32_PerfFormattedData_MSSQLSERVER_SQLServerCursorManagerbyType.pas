...
{TWin32_PerfFormattedData_MSSQLSERVER_SQLServerCursorManagerbyType}
 ...
 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerCursorManagerbyType.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLSERVER_SQLServerCursorManagerbyType.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLSERVER_SQLServerCursorManagerbyType');
 end;
