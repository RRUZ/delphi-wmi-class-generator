...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerGeneralStatistics}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerGeneralStatistics.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerGeneralStatistics.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerGeneralStatistics');
 end;
