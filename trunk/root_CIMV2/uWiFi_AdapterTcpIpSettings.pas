...
/// Creation Date 26-09-2011 03:22:47
/// Namespace root\CIMV2 Class WiFi_AdapterTcpIpSettings
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/WiFi_AdapterTcpIpSettings.asp
/// </summary>
...
unit uWiFi_AdapterTcpIpSettings;
...
{$ENDIF}
  ...
  TWiFi_AdapterTcpIpSettings=class(TWmiClass)
  private
    FCaption                            : String;
...
{TWiFi_AdapterTcpIpSettings}

constructor TWiFi_AdapterTcpIpSettings.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','WiFi_AdapterTcpIpSettings');
end;

destructor TWiFi_AdapterTcpIpSettings.Destroy;
begin
  inherited;
end;

procedure TWiFi_AdapterTcpIpSettings.SetCollectionIndex(Index : Integer);
begin
...
function TWiFi_AdapterTcpIpSettings.GetAPIVersion: integer;
var
...
//not static, OutParams=1, InParams>0
function TWiFi_AdapterTcpIpSettings.IsCurrentProfile(const ProfileName : String): Integer;
var
  ReturnValue : OleVariant;
begin
...
//not static, OutParams=1, InParams=0
function TWiFi_AdapterTcpIpSettings.Disassociate: integer;
var
  ReturnValue : OleVariant;
begin
