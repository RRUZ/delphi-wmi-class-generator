...
/// Creation Date 24-12-2010 09:38:03
/// Namespace root\CIMV2 Class Win32_ProgIDSpecification
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_ProgIDSpecification.asp
/// </summary>
...
unit uWin32_ProgIDSpecification;
...
{$ENDIF}
  ...
  /// <summary>
  /// Instances of this class represent and ProgIDs that need to be registered 
  /// durring a given installation.
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  TWin32_ProgIDSpecification=class(TWmiClass)
  private
    FCaption                            : String;
    FCheckID                            : String;
    FCheckMode                          : Boolean;
  ...
  /// TWin32_ProgIDSpecification.SoftwareElementState
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
  ...
  /// <summary>
  /// Return the description for the value of the property 
  /// TWin32_ProgIDSpecification.TargetOperatingSystem
  /// </summary>
  {$IFDEF UNDEF}{$ENDREGION}{$ENDIF}
...
{TWin32_ProgIDSpecification}

constructor TWin32_ProgIDSpecification.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_ProgIDSpecification');
end;

destructor TWin32_ProgIDSpecification.Destroy;
begin
  inherited;
end;

procedure TWin32_ProgIDSpecification.SetCollectionIndex(Index : Integer);
begin
  ...
  begin
    ...
    FParent                     := VarStrNull(inherited Value['Parent']);
...
function TWin32_ProgIDSpecification.Invoke: integer;
var
