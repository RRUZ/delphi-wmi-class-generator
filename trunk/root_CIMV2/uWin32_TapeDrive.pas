...
type
  ...
  private
   ...
   FDeviceID                           : String;
   FECC                                : LongInt;
   FEOTWarningZoneSize                 : LongInt;
   FErrorCleared                       : Boolean;
   FErrorDescription                   : String;
   FErrorMethodology                   : String;
   FFeaturesHigh                       : LongInt;
   FFeaturesLow                        : LongInt;
   FId                                 : String;
  ...
  public
   ...
   ///<summary>
   ///The Compression property specifies whether hardware data compression is enabled 
   ///or disabled.
   ///Values: 1 (true) or 0 (false). If true, hardware data compression 
   ///is enabled.
   ///</summary>
   property Compression : LongInt read FCompression;
   ///<summary>
   ...
   ///<summary>
   ///The ECC property specifies whether the device supports hardware error 
   ///correction.
   ///Values: 1 (true) or 0 (false). If true, hardware error correction 
   ///is supported.
   ///</summary>
   property ECC : LongInt read FECC;
   ///<summary>
   ...
   ///</summary>
   property EOTWarningZoneSize : LongInt read FEOTWarningZoneSize;
   ///<summary>
   ...
   ///features flag.
   ///</summary>
   property FeaturesHigh : LongInt read FFeaturesHigh;
   ///<summary>
   ///The FeaturesLow property specifies the low-order 32 bits of the device features 
   ///flag.
   ///</summary>
   property FeaturesLow : LongInt read FFeaturesLow;
   ///<summary>
   ...
   ///drive.
   ///</summary>
   property MaxPartitionCount : LongInt read FMaxPartitionCount;
   ///<summary>
   ...
   ///</summary>
   property Padding : LongInt read FPadding;
   ///<summary>
   ...
   ///<summary>
   ///The ReportSetMarks property specifies whether setmark reporting is enabled. 
   ///Setmark reporting makes use of a specialized recorded element that does not 
   ///contain user data. This recorded element is used to provide a segmentation 
   ///scheme. This segmentation scheme is hierarchically superior to filemarks. 
   ///Setmarks provide faster positioning on high-capacity tapes.
   ///Values: 1 (true) or 
   ///0 (false). If true, setmark reporting is enabled.
   ///</summary>
   property ReportSetMarks : LongInt read FReportSetMarks;
   ///<summary>
...
{TWin32_TapeDrive}
 ...
 constructor TWin32_TapeDrive.Create;
 begin
   Create(True);
 end;

 constructor TWin32_TapeDrive.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_TapeDrive');
 end;
 ...
 begin
    ...
    begin
       ...
       FCompression                         :=VarLongNull(GetPropertyValue('Compression'));
       ...
       FECC                                 :=VarLongNull(GetPropertyValue('ECC'));
       FEOTWarningZoneSize                  :=VarLongNull(GetPropertyValue('EOTWarningZoneSize'));
       ...
       FFeaturesHigh                        :=VarLongNull(GetPropertyValue('FeaturesHigh'));
       FFeaturesLow                         :=VarLongNull(GetPropertyValue('FeaturesLow'));
       ...
       FMaxPartitionCount                   :=VarLongNull(GetPropertyValue('MaxPartitionCount'));
       ...
       FPadding                             :=VarLongNull(GetPropertyValue('Padding'));
       ...
       FReportSetMarks                      :=VarLongNull(GetPropertyValue('ReportSetMarks'));
...
function TWin32_TapeDrive.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_TapeDrive');
