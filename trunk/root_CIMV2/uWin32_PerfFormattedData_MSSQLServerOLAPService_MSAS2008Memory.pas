...
/// Namespace root\CIMV2 Class Win32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Memory
/// MSDN info about this class http://msdn2.microsoft.com/library/default.asp?url=/library/en-us/wmisdk/wmi/Win32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Memory.asp
/// </summary>
...
unit uWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Memory;
...
{$ENDIF}
  ...
  TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Memory=class(TWmiClass)
  private
...
{TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Memory}

constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Memory.Create(LoadWmiData : boolean=True);
begin
  inherited Create(LoadWmiData,'root\CIMV2','Win32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Memory');
end;

destructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Memory.Destroy;
begin
  inherited;
end;

procedure TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Memory.SetCollectionIndex(Index : Integer);
begin
