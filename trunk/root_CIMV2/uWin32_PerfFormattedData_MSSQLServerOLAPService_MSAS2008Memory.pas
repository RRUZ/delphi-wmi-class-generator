...
{TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Memory}
 ...
 constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Memory.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Memory.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_MSSQLServerOLAPService_MSAS2008Memory');
 end;
