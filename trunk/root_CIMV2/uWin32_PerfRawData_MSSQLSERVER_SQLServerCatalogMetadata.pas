...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerCatalogMetadata}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerCatalogMetadata.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerCatalogMetadata.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerCatalogMetadata');
 end;
