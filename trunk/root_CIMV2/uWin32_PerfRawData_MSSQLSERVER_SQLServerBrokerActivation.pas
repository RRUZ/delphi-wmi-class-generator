...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerBrokerActivation}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerBrokerActivation.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerBrokerActivation.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerBrokerActivation');
 end;
