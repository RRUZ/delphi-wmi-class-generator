...
type
   ///<summary>
   ///The Win32_MotherboardDevice class represents a device that contains the central 
   ///components of the Win32 computer system.
   ///Example: A single piece of hardware 
   ///containing a processor, bus, memory, and basic system interfaces
   ///</summary>
  ...
  public
   ...
   ///<summary>
   ///The DeviceID property contains a string that uniquely identifies this 
   ///motherboard.
   ///</summary>
   ...
   ///<summary>
   ///The PrimaryBusType property indicates the primary bus type of the 
   ///motherboard.
   ///Example: PCI
   ///</summary>
   property PrimaryBusType : String read FPrimaryBusType;
   ///<summary>
   ///The RevisionNumber property indicates the revision number of the 
   ///motherboard.
   ///Example: 00
   ///</summary>
...
{TWin32_MotherboardDevice}
 ...
 constructor TWin32_MotherboardDevice.Create;
 begin
   Create(True);
 end;

 constructor TWin32_MotherboardDevice.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_MotherboardDevice');
 end;
 ...
 begin
    ...
    begin
       ...
       FPrimaryBusType                      :=VarStrNull(GetPropertyValue('PrimaryBusType'));
       FRevisionNumber                      :=VarStrNull(GetPropertyValue('RevisionNumber'));
       FSecondaryBusType                    :=VarStrNull(GetPropertyValue('SecondaryBusType'));
...
function TWin32_MotherboardDevice.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_MotherboardDevice');
