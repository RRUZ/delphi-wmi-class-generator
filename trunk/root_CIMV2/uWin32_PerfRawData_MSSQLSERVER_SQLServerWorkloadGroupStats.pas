...
{TWin32_PerfRawData_MSSQLSERVER_SQLServerWorkloadGroupStats}
 ...
 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerWorkloadGroupStats.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfRawData_MSSQLSERVER_SQLServerWorkloadGroupStats.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfRawData_MSSQLSERVER_SQLServerWorkloadGroupStats');
 end;
