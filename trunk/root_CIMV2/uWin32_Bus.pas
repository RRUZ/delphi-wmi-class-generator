...
type
   ///<summary>
   ///The Win32_Bus class represents a physical bus as seen by a Win32 operating 
   ///system. Any instance of a Win32 bus is a descendent (or member) of this 
   ///class.
   ///Example: USB Bus.
   ///</summary>
  ...
  public
   ...
   ///<summary>
   ///The BusNum property indicates the logical number assigned to the physical 
   ///bus.
   ///Example: 1
   ///</summary>
   property BusNum : LongInt read FBusNum;
   ///<summary>
   ///The BusType property indicates the type of the physical bus. This value will be 
   ///one of the values in the INTERFACE_TYPE enumeration defined in bus.h.
   ///Example: 
   ///PCIBus
   ///</summary>
   property BusType : LongInt read FBusType;
   ///<summary>
...
{TWin32_Bus}
 ...
 constructor TWin32_Bus.Create;
 begin
   Create(True);
 end;

 constructor TWin32_Bus.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_Bus');
 end;
 ...
 begin
    ...
    begin
       ...
       FBusNum                              :=VarLongNull(GetPropertyValue('BusNum'));
       FBusType                             :=VarLongNull(GetPropertyValue('BusType'));
...
function TWin32_Bus.SetPowerState(PowerState : Word;Time : TDateTime): Integer;
var
...
begin
  ...
  objInvoker      := objWMIService.InstancesOf('Win32_Bus');
