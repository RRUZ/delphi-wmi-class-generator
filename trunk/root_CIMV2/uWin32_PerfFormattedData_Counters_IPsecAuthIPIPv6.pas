...
{TWin32_PerfFormattedData_Counters_IPsecAuthIPIPv6}
 ...
 constructor TWin32_PerfFormattedData_Counters_IPsecAuthIPIPv6.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_Counters_IPsecAuthIPIPv6.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_Counters_IPsecAuthIPIPv6');
 end;
