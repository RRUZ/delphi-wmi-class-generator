...
{TWin32_PerfFormattedData_NETFramework_NETCLRRemoting}
 ...
 constructor TWin32_PerfFormattedData_NETFramework_NETCLRRemoting.Create;
 begin
   Create(True);
 end;

 constructor TWin32_PerfFormattedData_NETFramework_NETCLRRemoting.Create(LoadData: boolean);
 begin
   Create(LoadData,'root\CIMV2','Win32_PerfFormattedData_NETFramework_NETCLRRemoting');
 end;
